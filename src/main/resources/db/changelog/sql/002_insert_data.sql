...
VALUES (3, 'Java Core');
INSERT INTO topics (id, name)
VALUES (4, 'Java Collections Framework');
INSERT INTO topics (id, name)
VALUES (5, 'Java 8');
INSERT INTO topics (id, name)
VALUES (6, 'JDBC');
...
VALUES (8, 'Основы Web');
INSERT INTO topics (id, name)
VALUES (9, 'Servlets, JSP, JSTL');
INSERT INTO topics (id, name)
VALUES (10, 'Потоки ввода-вывода');
INSERT INTO topics (id, name)
VALUES (11, 'Сериализация');
INSERT INTO topics (id, name)
VALUES (12, 'Многопоточность');
INSERT INTO topics (id, name)
VALUES (13, 'Базы данных');
INSERT INTO topics (id, name)
VALUES (14, 'Шаблоны проектированния');


INSERT INTO exercises (id, question, answer, topic_id)
VALUES (1, 'Что такое ООП?',
        ...
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (2, 'Назовите основные принципы ООП.',
        '  Инкапсуляция - сокрытие реализации.  Наследование - создание новой сущности на базе уже существующей.  Полиморфизм - возможность иметь разные формы для одной и той же сущности.  Абстракция - набор общих характеристик.  Посылка сообщений - форма связи, взаимодействия между сущностями.  Переиспользование- все что перечислено выше работает на повторное использование кода.Это единственно верный порядок парадигм ООП, так как каждая последующая использует предыдущие.',
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (3, 'Что такое «инкапсуляция»?',
        ...
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (4, 'Что такое «наследование»?',
        'Наследование – это свойство системы, позволяющее описать новый класс на основе уже существующего с частично или полностью заимствующейся функциональностью.Класс, от которого производится наследование, называется предком, базовым или родительским. Новый класс – потомком, наследником или производным классом.',
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (5, 'Что такое «полиморфизм»?',
...
VALUES (6, 'Что такое «абстракция»?',
        ...
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (7, 'Что представляет собой «обмен сообщениями»?',
        ...
        1);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (8, 'Расскажите про основные понятия ООП: «класс», «объект», «интерфейс».',
...
VALUES (13, 'Что такое «каналы»?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (14, 'Какие существуют виды потоков ввода/вывода?',
...
VALUES (18, 'Для чего используется SequenceInputStream?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (19, 'Какой класс позволяет читать данные из входного байтового потока в формате примитивных типов данных?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (20, 'Какие подклассы класса OutputStream вы знаете, для чего они предназначены?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (21, 'Какие подклассы класса Reader вы знаете, для чего они предназначены?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (22, 'Какие подклассы класса Writer вы знаете, для чего они предназначены?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (23, 'В чем отличие класса PrintWriter от PrintStream?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (24, 'Чем отличаются и что общего у InputStream, OutputStream, Reader, Writer?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (25, 'Какие классы позволяют преобразовать байтовые потоки в символьные и обратно?',
        '  OutputStreamWriter — «мост» между классом OutputStream и классом Writer. Символы, записанные в поток, преобразовываются в байты.  InputStreamReader — аналог для чтения. При помощи методов класса Reader читаются байты из потока InputStream и далее преобразуются в символы.',
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (26, 'Какие классы позволяют ускорить чтение/запись за счет использования буфера?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (27, 'Какой класс предназначен для работы с элементами файловой системы?',
...
VALUES (29, 'Что вы знаете об интерфейсе FileFilter?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (30, 'Как выбрать все элементы определенного каталога по критерию (например, с определенным расширением)?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (31, 'Что вы знаете о RandomAccessFile?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (32, 'Какие режимы доступа к файлу есть у RandomAccessFile?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (33, 'Какие классы поддерживают чтение и запись потоков в компрессированном формате?',
        '  DeflaterOutputStream - компрессия данных в формате deflate.  Deflater - компрессия данных в формат ZLIB  ZipOutputStream - потомок DeflaterOutputStream для компрессии данных в формат Zip.  GZIPOutputStream - потомок DeflaterOutputStream для компрессии данных в формат GZIP.  InflaterInputStream - декомпрессия данных в формате deflate.  Inflater - декомпрессия данных в формате ZLIB  ZipInputStream - потомок InflaterInputStream для декомпрессии данных в формате Zip.  GZIPInputStream - потомок InflaterInputStream для декомпрессии данных в формате GZIP.',
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (34, 'Существует ли возможность перенаправить потоки стандартного ввода/вывода?',
        'Класс System позволяет вам перенаправлять стандартный ввод, вывод и поток вывода ошибок, используя простой вызов статического метода:  setIn(InputStream) - для ввода;  setOut(PrintStream) - для вывода;  setErr(PrintStream) - для вывода ошибок.',
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (35, 'Какой символ является разделителем при указании пути в файловой системе?',
        'Для различных операционных систем символ разделителя различается. Для Windows это \\, для Linux - /.В Java получить разделитель для текущей операционной системы можно через обращение к статическому полю File.separator.',
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (36, 'Что такое «абсолютный путь» и «относительный путь»?',
        'Абсолютный (полный) путь — это путь, который указывает на одно и то же место в файловой системе, вне зависимости от текущей рабочей директории или других обстоятельств. Полный путь всегда начинается с корневого каталога.Относительный путь представляет собой путь по отношению к текущему рабочему каталогу пользователя или активного приложения.',
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (37, 'Что такое «символьная ссылка»?',
        ...
        10);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (38, 'Что такое «сериализация»?',
        ...
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (39, 'Опишите процесс сериализации/десериализации с использованием Serializable.',
        'При использовании Serializable применяется алгоритм сериализации, который с помощью рефлексии (Reflection API) выполняет:  запись в поток метаданных о классе, ассоциированном с объектом (имя класса, идентификатор SerialVersionUID, идентификаторы полей класса);  рекурсивную запись в поток описания суперклассов до класса java.lang.Object (не включительно);  запись примитивных значений полей сериализуемого экземпляра, начиная с полей самого верхнего суперкласса;  рекурсивную запись объектов, которые являются полями сериализуемого объекта.При этом ранее сериализованные объекты повторно не сериализуются, что позволяет алгоритму корректно работать с циклическими ссылками.Для выполнения десериализации под объект выделяется память, после чего его поля заполняются значениями из потока. Конструктор объекта при этом не вызывается. Однако при десериализации будет вызван конструктор без параметров родительского несериализуемого класса, а его отсутствие повлечёт ошибку десериализации.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (40, 'Как изменить стандартное поведение сериализации/десериализации?',
        '  Реализовать интерфейс java.io.Externalizable, который позволяет применение пользовательской логики сериализации. Способ сериализации и десериализации описывается в методах writeExternal() и readExternal(). Во время десериализации вызывается конструктор без параметров, а потом уже на созданном объекте вызывается метод readExternal.  Если у сериализуемого объекта реализован один из следующих методов, то механизм сериализации будет использовать его, а не метод по умолчанию :o writeObject() - запись объекта в поток;o readObject() - чтение объекта из потока;o writeReplace() - позволяет заменить себя экземпляром другого класса перед записью;o readResolve() - позволяет заменить на себя другой объект после чтения.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (41, 'Как исключить поля из сериализации?',
        ...
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (42, 'Что обозначает ключевое слово transient?',
        'Поля класса, помеченные модификатором transient, не сериализуются.Обычно в таких полях хранится промежуточное состояние объекта, которое, к примеру, проще вычислить. Другой пример такого поля - ссылка на экземпляр объекта, который не требует сериализации или не может быть сериализован.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (43, 'Какое влияние оказывают на сериализуемость модификаторы полей static и final',
        ...
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (44, 'Как не допустить сериализацию?',
        'Чтобы не допустить автоматическую сериализацию можно переопределить private методы для создания исключительной ситуации NotSerializableException.Любая попытка записать или прочитать этот объект теперь приведет к возникновению исключительной ситуации.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (45, 'Как создать собственный протокол сериализации?',
...
VALUES (47, 'Когда стоит изменять значение поля serialVersionUID?',
        ...
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (48, 'В чем проблема сериализации Singleton?',
        'Проблема в том что после десериализации мы получим другой объект. Таким образом, сериализация дает возможность создать Singleton еще раз, что недопустимо. Существует два способа избежать этого:  явный запрет сериализации.  определение метода с сигнатурой (default/public/private/protected/) Object readResolve() throws ObjectStreamException, назначением которого станет возврат замещающего объекта вместо объекта, на котором он вызван.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (49, 'Какие существуют способы контроля за значениями десериализованного объекта',
        'Если есть необходимость выполнения контроля за значениями десериализованного объекта, то можно использовать интерфейс ObjectInputValidation с переопределением метода validateObject().// Если вызвать метод validateObject() после десериализации объекта, то будет вызвано исключение InvalidObjectException при значении возраста за пределами 39...60.Так же существуют способы подписывания и шифрования, позволяющие убедиться, что данные не были изменены:  с помощью описания логики в writeObject() и readObject().  поместить в оберточный класс javax.crypto.SealedObject и/или java.security.SignedObject. Данные классы являются сериализуемыми, поэтому при оборачивании объекта в SealedObject создается подобие «подарочной упаковки» вокруг исходного объекта. Для шифрования необходимо создать симметричный ключ, управление которым должно осуществляться отдельно. Аналогично, для проверки данных можно использовать класс SignedObject, для работы с которым также нужен симметричный ключ, управляемый отдельно.',
        11);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (50, 'Расскажите о модели памяти Java?',
        'Java Memory Model описывает поведение потоков в среде исполнения Java. Это набор правил, описывающий выполнение многопоточных программ и правил, по которым потоки могут взаимодействовать друг с другом. Модель памяти определяет набор действий межпоточного взаимодействия (эти действия включают в себя, чтение и запись переменной, захват и освобождений монитора, чтение и запись volatile переменной, запуск нового потока), а также модель памяти определяет отношение между этими действиями -happens-before - абстракции обозначающей, что если операция X связана отношением happens-before с операцией Y, то весь код следуемый за операцией Y, выполняемый в одном потоке, видит все изменения, сделанные другим потоком, до операции X. Правила для отношения happens-before:
В рамках одного потока любая операция happens-before любой операцией, следующей за ней;
Освобождение монитора happens-before захват того же монитора;
Выход из synchronized блока/метода happens-before входа на том же мониторе;
Запись volatile поля happens-before чтение того же поля;
Вызов метода start() экземпляра класса Thread happens-before начало метода run() экземпляра того же потока;
Завершение конструктора happens-before начало метода finalize() этого класса;
Вызов метода interrupt() на потоке happens-before обнаружению потоком факта, что данный метод был вызван либо путем выбрасывания исключения, либо с помощью методов interrupted().
...
Видимость (visibility). Один поток может в какой-то момент временно сохранить значение некоторых полей в регистры или лок кэш процессора, и второй поток, выполняемый на другом процессоре, читая из основной памяти, может не увидеть последних изменений поля. И наоборот. С точки зрения Java все переменные (за исключением лок переменных внутри метода) хранятся в главной памяти, которая доступна всем потокам, а так же каждый поток имеет лок память, где он хранит копии переменных, с которыми он работает, и при выполнении программы поток работает только с этими копиями. При входе в synchronized метод или блок поток обновляет содержимое лок памяти, а при выходе записывает изменения, сделанные в лок памяти, в главную. Все операции с памятью происходят раньше освобождения монитора и все операции с памятью до выхода из synchronized блока видны любому потоку, который входит в synchronized блок для того же самого монитора. Очень важно, что это правило работает только в том случае, если потоки синхронизируются, используя один и тот же монитор!
Volatile переменные минуют лок память, запись и чтение volotile производится из основной памяти.
Модель памяти определяет дополнительную семантику ключевого слова final, имеющую отношение к видимости: после того как объект был корректно создан(ссылка на создающийся объект не использовалась, пока не завершился конструктор объекта), любой поток может видеть значения его final полей без дополнительной синхронизации. Это позволяет создать immutable объекты, содержащие только final поля, такие объекты могут свободно передаваться между потоками без синхронизации. Рекомендуется изменять final поля объекта только внутри конструктора.
Reordering (переупорядочивание). Для увеличения производительности процессор может решить поменять порядок выполнения операций, если сочтет что такая последовательность быстрее. Вопрос reordering регулируется набором правил для отношения «происходит раньше» и у этих правил есть следствие: операции чтения и записи volatile переменных не могут быть переупорядочены с операциями чтения и записи других volatile и не-volatile переменных. Это следствие делает возможным использование volatile переменной как флага, сигнализирующем об окончании какого-либо действия.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (51, 'Что такое «потокобезопасность»?',
...
VALUES (55, 'Чем отличается процесс от потока?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (56, 'Что такое «зелёные потоки» и есть ли они в Java?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (57, 'Каким образом можно создать поток?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (58, 'Чем различаются Thread и Runnable?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (59, 'В чём заключается разница между методами start() и run()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (60, 'Как принудительно запустить поток?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (61, 'Что такое «монитор» в Java?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (62, 'Дайте определение понятию «синхронизация».',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (63, 'Какие существуют способы синхронизации в Java?',
...
VALUES (66, 'Зачем может быть нужен private мьютекс?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (67, 'Как работают методы wait() и notify()/notifyAll()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (68, 'В чем разница между notify() и notifyAll()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (69, 'Почему методы wait() и notify() вызываются только в синхронизированном блоке?',
        'Монитор надо захватывать в явном виде (через synchronized-блок), потому что методы wait() и notify() не синхронизированы.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (70, 'Чем отличается работа метода wait() с параметром и без параметра?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (71, 'Чем отличаются методы Thread.sleep() и Thread.yield()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (72, 'Как работает метод Thread.join()?',
        'Когда поток вызывает join() для другого потока, текущий работающий поток будет ждать, пока другой поток, к которому он присоединяется, не будет завершён:void join()        void join(long millis) void join(long millis, int nanos) ',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (73, 'Что такое deadlock?',
        'Взаимная блокировка (deadlock) - явление, при котором все потоки находятся в режиме ожидания. Происходит, когда достигаются состояния:1. взаимного исключения: по крайней мере один ресурс занят в режиме неделимости и, следовательно, только один поток может использовать ресурс в любой данный момент времени.2. удержания и ожидания: поток удерживает как минимум один ресурс и запрашивает дополнительные ресурсов, которые удерживаются другими потоками.3. отсутствия предочистки: операционная система не переназначивает ресурсы: если они уже заняты, они должны отдаваться удерживающим потокам сразу же.4. цикличного ожидания: поток ждёт освобождения ресурса, другим потоком, который в свою очередь ждёт освобождения ресурса заблокированного первым потоком.Простейший способ избежать взаимной блокировки – не допускать цикличного ожидания. Этого можно достичь, получая мониторы разделяемых ресурсов в определённом порядке и освобождая их в обратном порядке.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (74, 'Что такое livelock?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (75, 'Как проверить, удерживает ли поток монитор определённого ресурса?',
        'Метод Thread.holdsLock(lock) возвращает true, когда текущий поток удерживает монитор у определённого объекта.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (76, 'На каком объекте происходит синхронизация при вызове static synchronized метода?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (77, 'Для чего используется ключевое слово volatile, synchronized, transient, native?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (78, 'В чём различия между volatile и Atomic переменными?',
...
VALUES (79,
        ...
        '  weakCompareAndSwap() не создает memory barrier и не дает гарантии happens-before;  weakCompareAndSwap() сильно зависит от кэша/CPU, и может возвращать false без видимых причин;  weakCompareAndSwap(), более легкая, но поддерживаемая далеко не всеми архитектурами и не всегда эффективная операция.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (80, 'Что значит «приоритет потока»?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (81, 'Что такое «потоки-демоны»?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (82, 'Можно ли сделать основной поток программы демоном?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (83, 'Что значит «усыпить» поток?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (84, 'Чем отличаются два интерфейса Runnable и Callable?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (85, 'Что такое FutureTask?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (86, 'В чем заключаются различия между CyclicBarrier и CountDownLatch?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (87, 'Что такое race condition?',
...
VALUES (90, 'Почему не рекомендуется использовать метод Thread.stop()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (91, 'Что происходит, когда в потоке выбрасывается исключение?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (92, 'В чем разница между interrupted() и isInterrupted()?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (93, 'Что такое «пул потоков»?',
...
VALUES (95, 'Что будет, если очередь пула потоков уже заполнена, но подаётся новая задача?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (96, 'В чём заключается различие между методами submit() и execute() у пула потоков?',
        'Оба метода являются способами подачи задачи в пул потоков, но между ними есть небольшая разница.execute(Runnable command) определён в интерфейсе Executor и выполняет поданную задачу и ничего не возвращает.submit() – перегруженный метод, определённый в интерфейсе ExecutorService. Способен принимать задачи типов Runnable и Callable и возвращать объект Future, который можно использовать для контроля и управления процессом выполнения, получения его результата.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (97, 'В чем заключаются различия между cтеком (stack) и кучей (heap) с точки зрения многопоточности?',
...
VALUES (103, 'Что такое ReadWriteLock?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (104, 'Что такое «блокирующий метод»?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (105, 'Что такое «фреймворк Fork/Join»?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (106, 'Что такое Semaphore?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (107, 'Что такое double checked locking Singleton?',
        'double checked locking Singleton - это один из способов создания потокобезопасного класса реализующего шаблон Одиночка. Данный метод пытается оптимизировать производительность, блокируясь только случае, когда экземпляр одиночки создаётся впервые.Следует заметить, что требование volatile обязательно. Проблема Double Checked Lock заключается в модели памяти Java, точнее в порядке создания объектов, когда возможна ситуация, при которой другой поток может получить и начать использовать (на основании условия, что указатель не нулевой) не полностью сконструированный объект. Хотя эта проблема была частично решена в JDK 1.5, однако рекомендация использовать volatile для Double Cheсked Lock остаётся в силе.',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (108, 'Как создать потокобезопасный Singleton?',
        '  Static fieldpublic class Singleton {	public static final Singleton INSTANCE = new Singleton();}  Enumpublic enum Singleton {	INSTANCE;}  Synchronized Accessorpublic class Singleton {	private static Singleton instance;		public static synchronized Singleton getInstance() {		if (instance == null) {			instance = new Singleton();		}		return instance;	}}  Double Checked Locking & volatilepublic class Singleton {        private static volatile Singleton instance;	        public static Singleton getInstance() {		Singleton localInstance = instance;		if (localInstance == null) {			synchronized (Singleton.class) {				localInstance = instance;				if (localInstance == null) {					instance = localInstance = new Singleton();				}			}		}		return localInstance;	}}  On Demand Holder Idiompublic class Singleton {			public static class SingletonHolder {		public static final Singleton HOLDER_INSTANCE = new Singleton();	}			public static Singleton getInstance() {		return SingletonHolder.HOLDER_INSTANCE;	}}',
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (109, 'Чем полезны неизменяемые объекты?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (110, 'Что такое busy spin?',
...
VALUES (113, 'Даны 3 потока Т1, Т2 и Т3? Как реализовать выполнение в последовательности Т1, Т2, Т3?',
        ...
        12);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (114, '﻿Что такое «база данных»?',
        'База данных — организованный и адаптированный для обработки вычислительной системой набор информации.', 13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (115, 'Что такое «система управления базами данных»?',
...
VALUES (117,
        ...
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (118, 'Что такое «первичный ключ» (primary key)? Каковы критерии его выбора?',
        'Первичный ключ (primary key) в реляционной модели данных один из потенциальных ключей отношения, выбранный в качестве основного ключа (ключа по умолчанию).Если в отношении имеется единственный потенциальный ключ, он является и первичным ключом. Если потенциальных ключей несколько, один из них выбирается в качестве первичного, а другие называют «альтернативными».В качестве первичного обычно выбирается тот из потенциальных ключей, который наиболее удобен. Поэтому в качестве первичного ключа, как правило, выбирают тот, который имеет наименьший размер (физического хранения) и/или включает наименьшее количество атрибутов. Другой критерий выбора первичного ключа — сохранение его уникальности со временем. Поэтому в качестве первичного ключа стараются выбирать такой потенциальный ключ, который с наибольшей вероятностью никогда не утратит уникальность.',
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (119, 'Что такое «внешний ключ» (foreign key)?',
        ...
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (120, 'Что такое «нормализация»?',
...
VALUES (127, 'Имеет ли смысл индексировать данные, имеющие небольшое количество возможных значений?',
        ...
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (128, 'Когда полное сканирование набора данных выгоднее доступа по индексу?',
        ...
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (129, 'Что такое «транзакция»?',
        ...
        13);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (130, 'Назовите основные свойства транзакции.',
...
VALUES (140, 'Что такое «антипаттерн»? Какие антипаттерны вы знаете?',
        ...
        14);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (141, 'Что такое Dependency Injection?',
        ...
        14);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (142, '﻿За что отвечает JVM?',
        '  Загрузка, проверка и исполнение байт кода;  Предоставление среды выполнения для выполнения байт-кода;  Управление памятью и очисткой мусора (Garbage collection);Виртуальная машина Java (Java Virtual Machine) - это механизм, предоставляющий среду выполнения для управления Java-кодом или приложениями.Виртуальная машина является независимой оболочкой исполнения кода, благодаря которой возможен её запуск на любой ОС,без влияния ОС на выполняемую программу.JVM работает с 2мя типами данных:  примитивные типы (primitive types) и ссылочные типы (reference types).ПримитивыJVM работает с примитивными значениями (целыми числами и числами с плавающей точкой). По сути, JVM - это 32-битная машина.Типы long и double, которые являются 64-битными, поддерживаются изначально, но занимают две единицы памяти в frame''s localили стеке операндов, поскольку каждая единица составляет 32 бита.Типы boolean, byte, short и char имеют расширенный знак (кроме char с нулевым расширением) и работают как 32-разрядные целые числа, так же, как и типы int.Меньшие типы имеют только несколько специфических для типа инструкций для загрузки, хранения и преобразования типов.boolean значение работает как 8-битное byte значения, где 0 представляет значение false, а 1 - значение true.Типы ссылок и значенияСуществует три типа ссылочных типов: типы классов, типы массивов и типы интерфейсов.Их значения являются ссылками на динамически создаваемые экземпляры классов, массивы или экземпляры классов,которые реализуют интерфейсы соответственно.',
        2);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (143, 'Classloader',
        'Загрузчик классов является частью JRE, которая динамически загружает Java классы в JVM.Обычно классы загружаются только по запросу. Система исполнения в Java не должна знать о файлах и файловых системахблагодаря загрузчику классов. Делегирование является важной концепцией, которую выполняет загрузчик. Загрузчик классовотвечает за поиск библиотек, чтение их содержимого и загрузку классов, содержащихся в библиотеках.Эта загрузка обычно выполняется «по требованию», поскольку она не происходит до тех пор, пока программа не вызовет класс.Класс с именем может быть загружен только один раз данным загрузчиком классов.При запуске JVM, используются три загрузчика классов:* Bootstrap class loader (Загрузчик класса Bootstrap)* Extensions class loader (Загрузчик класса расширений)* System class loader (Системный загрузчик классов)Загрузчик класса Bootstrap загружает основные библиотеки Java, расположенные в папке <JAVA_HOME>/jre/lib.Этот загрузчик является частью ядра JVM, написан на нативном коде.Загрузчик класса расширений загружает код в каталоги расширений(<JAVA_HOME>/jre/lib/ext, или любой другой каталог, указанный системным свойством java.ext.dirs).Системный загрузчик загружает код, найденный в java.class.path, который сопоставляется с переменной среды CLASSPATH.Это реализуется классом sun.misc.Launcher$AppClassLoader.Загрузчик классов выполняет три основных действия в строгом порядке:* Загрузка: находит и импортирует двоичные данные для типа.* Связывание: выполняет проверку, подготовку и (необязательно) разрешение.o Проверка: обеспечивает правильность импортируемого типа.o Подготовка: выделяет память для переменных класса и инициализация памяти значениями по умолчанию.o Разрешение: преобразует символические ссылки из типа в прямые ссылки.* Инициализация: вызывает код Java, который инициализирует переменные класса их правильными начальными значениями.Пользовательский загрузчик классовЗагрузчик классов написан на Java. Поэтому возможно создать свой собственный загрузчик классов, не понимая тонких деталей JVM.У каждого загрузчика классов Java есть родительский загрузчик классов, определенный при создании экземпляра новогозагрузчика классов или в качестве системного загрузчика классов по умолчанию для виртуальной машины.Что делает возможным следующее:* загружать или выгружать классы во время выполнения (например, динамически загружать библиотеки во время выполнения, даже из ресурса HTTP).Это важная особенность для:o реализация скриптовых языков;o использование bean builders;o добавить пользовательскую расширение;o позволяя нескольким пространствам имен общаться. Например, это одна из основ протоколов CORBA / RMI;* изменить способ загрузки байт-кода (например, можно использовать зашифрованный байт-код класса Java);* модифицировать загруженный байт-код (например, для переплетения аспектов во время загрузки при использовании аспектно-ориентированного программирования);',
        2);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (144, 'Области данных времени выполнения',
        'Run-Time Data Areas. JVM выделяет множество областей данных во время выполнения, которые используются во время выполнения программы. Некоторые участки данныхсозданы JVM во время старта и уничтожаются во время её выключения. Другие создаются для каждого потока и уничтожаются, когда поток уничтожается.The pc Register (PCR)Виртуальная машина Java может поддерживать много потоков исполнения одновременно. Каждый поток виртуальной машины Java имеет свой собственный регистр PC (program counter).В любой момент каждый поток виртуальной машины Java выполняет код одного метода, а именно текущий метод для этого потока.Если этот метод не является native, регистр pc содержит адрес инструкции виртуальной машины Java, выполняемой в настоящее время.Коротко говоря: для одного потока, существует один PCR, который создается при запуске потока. PCR хранит адрес выполняемой сейчас инструкции JVM.Java Virtual Machine StacksКаждый поток в JVM имеет собственный стек, созданный одновременно с потоком.  Стек в JVM хранит frames.Cтеки в JVM могут иметь фиксированный размер или динамически расширяться и сжиматься в соответствии с требованиями вычислений.HeapJVM имеет heap (кучу), которая используется всеми потоками виртуальной машины Java.Куча - это область данных времени выполнения, из которой выделяется память для всех экземпляров и массивов классов.Куча создается при запуске виртуальной машины. Хранилище для объектов восстанавливается автоматической системойуправления данными (известной как сборщик мусора); объекты никогда не освобождаются явно.JVM не предполагает какого-либо конкретного типа системы автоматического управления хранением данных,и метод управления может быть выбран в соответствии с системными требованиями разработчика.Куча может иметь фиксированный размер или может быть расширена в соответствии с требованиями вычислений и может быть сокращена,если большая куча становится ненужной. Память для кучи не должна быть смежной.Method AreaJVM имеет область методов, которая является общей для всех потоков. Она хранит структуры для каждого класса, такие как пул констант, данные полей и методов,а также код для методов и конструкторов, включая специальные методы, используемые при инициализации классов и экземпляров, и инициализации интерфейса.Хотя область метода является логически частью кучи, простые реализации могут не обрабатываться сборщиком мусора. Область метода может иметьфиксированный размер или может быть расширена в соответствии с требованиями вычислений и может быть сокращена, если большая область метода становится ненужной.Run-Time Constant PoolA run-time constant pool существует для каждого класса или интерфейса в рантайме и представленно constant_pool таблицей в *.class файле.Он содержит несколько видов констант: от числовых литералов, известных во время компиляции, до ссылок на методы и поля,которые должны быть разрешены во время выполнения.  Сам run-time constant pool выполняет функцию,аналогичную функции таблицы символов для обычного языка программирования, хотя он содержит более широкий диапазон данных, чем типичная таблица символов.Каждый run-time constant pool отделён от JVM''s method area. JVM создаёт run-time constant pool вместе с созданием class или interface.Native Method StacksРеализация виртуальной машины Java может использовать обычные стеки, обычно называемые «стеки Си», для поддержки native methods (методов, написанных на языке, отличном от языка программирования Java).',
        2);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (145, 'Frames',
        'Frame используется для хранения данных и частичных результатов, а также для выполнения динамического связывания, возврата значений для методов и отправки исключений. Новый frame создается, когда вызывается метод. Frame уничтожается, когда завершается вызов метода. Frames выделяются из стека потока, создающего frame. Каждый frame имеет собственный массив лок переменных, свой стек операндов и ссылку на пул констант во время выполнения класса текущего метода. Размеры массива лок переменных и стека операндов определяются во время компиляции и предоставляются вместе с кодом для метода, связанного с фреймом. Только один frame активен в любой точке данного потока управления -  текущий frame. Класс, в котором определен текущий метод, является текущим. Операции над лок переменными и стеком операндов обычно выполняются со ссылкой на текущий frame. Frame перестает быть текущим, если его метод вызывает другой метод или если его метод завершается. При возврате метода текущий frame передает результат вызова метода, в предыдущий frame. И предыдущий frame становится текущим. Frame, созданный потоком, является локальным для этого потока и на него не может ссылаться ни один другой поток. Каждый frame содержит массив переменных, известных как его лок переменные. Длина массива лок переменных frame определяется во время компиляции. Одна лок переменная может хранить значение: boolean, byte, char, short, int, float, reference. Пара лок переменных может хранить значение: long или double. Лок переменные адресуются путем индексации. Индекс первой локальной переменной равен 0. Значение типа long и double занимает две последовательные лок переменные. JVM использует лок переменные для передачи параметров при вызове метода. При вызове метода класса все параметры передаются в последовательных лок переменных, начиная с 0. При вызове метода экземпляра лок переменная 0 всегда используется для передачи ссылки на объект, для которого вызывается метод экземпляра (this в Java). Параметры передаются в последовательных лок переменных, начиная с 1. Каждый frame содержит стек(LIFO) операндов. Максимальная глубина стека операндов определяется во время компиляции и предоставляется вместе с кодом для метода, связанного с frame-ом. Стек операнда пуст при создании frame-a. JVM предоставляет инструкции для загрузки константных значений из лок переменных или полей в стек операндов. Другие инструкции JVM берут операнды из стека, оперируют с ними и помещают результат обратно. Стек операндов также используется для подготовки параметров для передачи в методы и для получения результатов метода. Каждый frame содержит ссылку на  run-time constant pool для типа текущего метода для поддержки динамического связывания метода. Доступ к вызываемым методам и переменным осуществляется через символические ссылки из class файла. Динамическое связывание преобразует эти симв. ссылки на методы в конкретные ссылки, загружая классы по мере необходимости  для разрешения еще не определенных символов. Позднее связывание методов и переменных вносит изменения в другие классы, которые метод использует с меньшей вероятностью нарушить этот код. Если вызов завершается нормально, то значение может быть возвращено вызывающему методу. Текущий frame используется в этом случае для восстановления состояния инициатора, включая его лок переменные и стек, с соответствующим образом увеличенным программным счетчиком инициатора, чтобы пропустить инструкцию вызова метода. Затем выполнение продолжается в frame вызывающего метода с возвращенным значением, помещаемым в стек операндов этого frame. Вызов метода завершается преждевременно, если при выполнении инструкции JVM в методе выдает исключение, и это исключение не обрабатывается в методе. Throw также приводит к явному выбрасыванию исключения, и, если оно не перехватывается текущим методом, приводит к неожиданному завершению вызова метода. Вызов метода, который завершается внезапно, никогда не возвращает значение своему вызывающему.',
        2);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (146, 'Execution Engine',
        'Байт-код, назначенный run-time data areas, будет выполнен execution engine. Механизм выполнения считывает байт-код и выполняет его по частям.InterpreterИнтерпретатор интерпретирует байт-код быстро, но выполняется медленно. Недостаток интерпретатора заключается в том, что, когда один метод вызывается несколько раз, каждый раз требуется новая интерпретация.JIT CompilerJIT-компилятор устраняет недостатки интерпретатора. Механизм выполнения будет использовать помощь интерпретатора при преобразовании байт-кода,но когда он находит повторный код, он использует JIT-компилятор, который компилирует весь байт-код и изменяет его на собственный код.Этот нативный код будет использоваться непосредственно для повторных вызовов методов, которые улучшают производительность системы.  Генератор промежуточного кода (Intermediate Code Generator). Производит промежуточный код.  Code Optimizer. Отвечает за оптимизацию промежуточного кода, сгенерированного выше.  Генератор целевого кода (Target Code Generator). Отвечает за генерацию машинного кода или родной код.  Профилировщик (Profiler). Специальный компонент, отвечающий за поиск горячих точек, то есть, вызывается ли метод несколько раз или нет.Garbage Collector',
        2);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (147, '﻿Чем различаются JRE, JVM и JDK?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (148, 'Какие существуют модификаторы доступа?',
        'private (приватный): члены класса доступны только внутри класса. Для обозначения используется служебное слово private.default, package-private, package level (доступ на уровне пакета): видимость класса/членов класса только внутри пакета. Является модификатором доступа по умолчанию - специальноеобозначение не требуется.protected (защищённый): члены класса доступны внутри пакета и в наследниках. Для обозначения используется служебное слово protected.public (публичный): класс/члены класса доступны всем. Для обозначения используется служебное слово public.Последовательность модификаторов по возрастанию уровня закрытости: public, protected, default, private.Во время наследования возможно изменения модификаторов доступа в сторону большей видимости (для поддержания соответствия принципу подстановки Барбары Лисков).',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (149, 'О чем говорит ключевое слово final?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (150, 'Какими значениями инициализируются переменные по умолчанию?',
        '  Числа инициализируются 0 или 0.0;  char — \\u0000;  boolean — false;  Объекты (в том числе String) — null.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (151, 'Что вы знаете о функции main()?',
        'Метод main() — точка входа в программу. В приложении может быть несколько таких методов. Если метод отсутствует, то компиляция возможна, но при запуске будет получена ошибка \\`Error: Main method not found\\`.public static void main(String[] args) {}',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (152, 'Какие логические операции и операторы вы знаете?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (153, 'Что такое тернарный оператор выбора?',
        'Тернарный условный оператор ?: - оператор, которым можно заменить некоторые конструкции операторов if-then-else.Выражение записывается в следующей форме:условие ? выражение1 : выражение2Если условие выполняется, то вычисляется выражение1 и его результат становится результатом выполнения всего оператора. Если же условие равно false, то вычисляется выражение2 и его значение становится результатом работы оператора. Оба операнда выражение1 и выражение2 должны возвращать значение одинакового (или совместимого) типа.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (154, 'Какие побитовые операции вы знаете?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (155, 'Где и для чего используется модификатор abstract?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (156, 'Дайте определение понятию «интерфейс». Какие модификаторы по умолчанию имеют поля и методы интерфейсов?',
...
VALUES (158, 'Почему в некоторых интерфейсах вообще не определяют методов?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (159, 'Почему нельзя объявить метод интерфейса с модификатором final?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (160, 'Что имеет более высокий уровень абстракции - класс, абстрактный класс или интерфейс?', 'Интерфейс.', 3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (161, 'Может ли объект получить доступ к члену класса, объявленному как private? Если да, то каким образом?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (162, 'Каков порядок вызова конструкторов и блоков инициализации с учётом иерархии классов?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (163, 'Зачем нужны и какие бывают блоки инициализации?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (164, 'К каким конструкциям Java применим модификатор static?',
        '  полям;  методам;  вложенным классам;  блокам инициализации;  членам секции import.', 3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (165, 'Для чего в Java используются статические блоки инициализации?',
        'Статические блоки инициализация используются для выполнения кода, который должен выполняться один раз при инициализации класса загрузчиком классов, в момент, предшествующий созданию объектов этого класса при помощи конструктора. Такой блок (в отличие от нестатических, принадлежащих конкретном объекту класса) принадлежит только самому классу (объекту метакласса Class).',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (166, 'Что произойдёт, если в блоке инициализации возникнет исключительная ситуация?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (167, 'Какое исключение выбрасывается при возникновении ошибки в блоке инициализации класса?',
        'Если возникшее исключение - наследник RuntimeException:  для статических блоков инициализации будет выброшено java.lang.ExceptionInInitializerError;  для нестатических будет проброшено исключение-источник.Если возникшее исключение - наследник Error, то в обоих случаях будет выброшено java.lang.Error. Исключение: java.lang.ThreadDeath - смерть потока. В этом случае никакое исключение выброшено не будет.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (168, 'Может ли статический метод быть переопределён или перегружен?',
...
VALUES (172, 'Можно ли объявить метод абстрактным и статическим одновременно?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (173, 'В чем разница между членом экземпляра класса и статическим членом класса?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (174, 'Где разрешена инициализация статических/нестатических полей?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (175, 'Какие типы классов бывают в java?',
        '  Top level class (Обычный класс):o Abstract class (Абстрактный класс);o Final class (Финализированный класс).  Interfaces (Интерфейс).  Enum (Перечисление).  Nested class (Вложенный класс):o Static nested class (Статический вложенный класс);o Member inner class (Простой внутренний класс);o Local inner class (Локальный класс);o Anonymous inner class (Анонимный класс).',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (176, 'Расскажите про вложенные классы. В каких случаях они применяются?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (177, 'Что такое «статический класс»?',
...
VALUES (178,
        ...
        '  Вложенные классы могут обращаться ко всем членам обрамляющего класса, в том числе и приватным.  Для создания объекта статического вложенного класса объект внешнего класса не требуется.  Из объекта статического вложенного класса нельзя обращаться к не статическим членам обрамляющего класса напрямую, а только через ссылку на экземпляр внешнего класса.  Обычные вложенные классы не могут содержать статических методов, блоков инициализации и классов. Статические вложенные классы - могут.  В объекте обычного вложенного класса хранится ссылка на объект внешнего класса. Внутри статической такой ссылки нет. Доступ к экземпляру обрамляющего класса осуществляется через указание .this после его имени. Например: Outer.this.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (179, 'Что такое «локальный класс»? Каковы его особенности?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (180, 'Что такое «анонимные классы»? Где они применяются?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (181, 'Каким образом из вложенного класса получить доступ к полю внешнего класса?',
...
VALUES (184,
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (185, 'Каким образом передаются переменные в методы, по значению или по ссылке?',
...
VALUES (187, 'Как работает сборщик мусора?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (188, 'Какие разновидности сборщиков мусора реализованы в виртуальной машине HotSpot?',
...
VALUES (190, 'Что такое «пул строк»?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (191, 'Что такое finalize()? Зачем он нужен?',
...
VALUES (192,
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (193, 'Чем отличаются final, finally и finalize()?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (194, 'Расскажите про приведение типов. Что такое понижение и повышение типа?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (195, 'Когда в приложении может быть выброшено исключение ClassCastException?',
        'ClassCastException (потомок RuntimeException) - исключение, которое будет выброшено при ошибке приведения типа.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (196, 'Что такое литералы?',
...
VALUES (200, 'Почему char[] предпочтительнее String для хранения пароля?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (201, 'Почему строка является популярным ключом в HashMap в Java?',
        'Поскольку строки неизменяемы, их хэш код вычисляется и кэшируется в момент создания, не требуя повторного пересчета при дальнейшем использовании. Поэтому в качестве ключа HashMap они будут обрабатываться быстрее.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (202, 'Что делает метод intern() в классе String?.',
        'Метод intern() используется для сохранения строки в пуле строк или получения ссылки, если такая строка уже находится в пуле.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (203, 'Можно ли использовать строки в конструкции switch?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (204, 'Какая основная разница между String, StringBuffer, StringBuilder?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (205, 'Что такое класс Object? Какие в нем есть методы?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (206, 'Дайте определение понятию «конструктор».',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (207, 'Что такое «конструктор по умолчанию»?',
        'Если у какого-либо класса не определить конструктор, то компилятор сгенерирует конструктор без аргументов - так называемый «конструктор по умолчанию».public class ClassName() {}Если у класса уже определен какой-либо конструктор, то конструктор по умолчанию создан не будет и, если он необходим, его нужно описывать явно.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (208, 'Чем отличаются конструктор по-умолчанию, конструктор копирования и конструктор с параметрами?',
...
VALUES (211, 'Что такое Reflection?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (212, 'Зачем нужен equals(). Чем он отличается от операции ==?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (213, 'Если вы хотите переопределить equals(), какие условия должны выполняться?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (214, 'Правила переопределения метода Object.equals().',
        '1. Использование оператора == для проверки, является ли аргумент ссылкой на указанный объект. Если является, возвращается true. Если сравниваемый объект == null, должно вернуться false.2. Использование вызова метода getClass() для проверки, имеет ли аргумент правильный тип. Если не имеет, возвращается false.3. Приведение аргумента к правильному типу. Поскольку эта операция следует за проверкой instanceof она гарантированно будет выполнена.4. Обход всех значимых полей класса и проверка того, что значение поля в текущем объекте и значение того же поля в проверяемом на эквивалентность аргументе соответствуют друг другу. Если проверки для всех полей прошли успешно, возвращается результат true, в противном случае - false.По окончанию переопределения метода equals() следует проверить: является ли порождаемое отношение эквивалентности рефлексивным, симметричным, транзитивным и непротиворечивым? Если ответ отрицательный, метод подлежит соответствующей правке.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (215, 'Какая связь между hashCode() и equals()?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (216, 'Что будет, если переопределить equals() не переопределяя hashCode()? Какие могут возникнуть проблемы?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (217, 'Каким образом реализованы методы hashCode() и equals() в классе Object?',
        'Реализация метода Object.equals() сводится к проверке на равенство двух ссылок:public boolean equals(Object obj) {  return (this == obj);}Реализация метода Object.hashCode() описана как native, т.е. определенной не с помощью Java кода и обычно возвращает адрес объекта в памяти:public native int hashCode();',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (218, 'Для чего нужен метод hashCode()?',
        'Метод hashCode() необходим для вычисления хэш кода переданного в качестве входного параметра объекта. В Java это целое число, в более широком смысле - битовая строка фиксированной длины, полученная из массива произвольной длины. Этот метод реализован таким образом, что для одного и того же входного объекта, хэш код всегда будет одинаковым. Следует понимать, что в Java множество возможных хэш кодов ограничено типом int, а множество объектов ничем не ограничено. Из-за этого, вполне возможна ситуация, что хэш коды разных объектов могут совпасть:  если хэш коды разные, то и объекты гарантированно разные;  если хэш коды равны, то объекты не обязательно равны(могут быть разные).',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (219, 'Каковы правила переопределения метода Object.hashCode()?',
        'Есть ли какие-либо рекомендации о том, какие поля следует использовать при подсчете hashCode()?Общий совет: выбирать поля, которые с большой долью вероятности будут различаться. Для этого необходимо использовать уникальные, лучше всего примитивные поля, например, такие как id, uuid. При этом нужно следовать правилу, если поля задействованы при вычислении hashCode(), то они должны быть задействованы и при выполнении equals().',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (220, 'Могут ли у разных объектов быть одинаковые hashCode()?',
...
VALUES (221,
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (222, 'Могут ли у разных объектов (ref0 != ref1) быть ref0.equals(ref1) == true?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (223, 'Могут ли у разных ссылок на один объект (ref0 == ref1) быть ref0.equals(ref1) == false?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (224, 'Можно ли так реализовать метод equals(Object that) {return this.hashCode() == that.hashCode()}?',
...
VALUES (230, 'Какой способ клонирования предпочтительней?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (231, 'Почему метод clone() объявлен в классе Object, а не в интерфейсе Cloneable?',
        'Метод clone() объявлен в классе Object с указанием модификатора native, чтобы обеспечить доступ к стандартному механизму поверхностного копирования объектов. Одновременно он объявлен и как protected, чтобы нельзя было вызвать этот метод у не переопределивших его объектов. Непосредственно интерфейс Cloneable является маркерным (не содержит объявлений методов) и нужен только для обозначения самого факта, что данный объект готов к тому, чтобы быть клонированным. Вызов переопределённого метода clone() у не Cloneable объекта вызовет выбрасывание CloneNotSupportedException.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (232, 'Опишите иерархию исключений.',
...
VALUES (235, 'О чем говорит ключевое слово throws?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (236, 'Как написать собственное («пользовательское») исключение?',
        'Необходимо унаследоваться от базового класса требуемого типа исключений (например, от Exception или RuntimeException).',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (237, 'Какие существуют unchecked exception?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (238, 'Что представляет из себя ошибки класса Error?',
...
VALUES (240, 'Опишите работу блока try-catch-finally.',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (241, 'Что такое механизм try-with-resources?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (242, 'Возможно ли использование блока try-finally (без catch)?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (243, 'Может ли один блок catch отлавливать сразу несколько исключений?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (244, 'Всегда ли исполняется блок finally?',
        'Код в блоке finally будет выполнен всегда, независимо от того, выброшено исключение или нет.', 3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (245, 'Существуют ли ситуации, когда блок finally не будет выполнен?',
...
VALUES (246,
        ...
        'Может и оно будет передано в виртуальную машину Java (JVM).', 3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (247,
        'Предположим, есть метод, который может выбросить IOException и FileNotFoundException в какой последовательности должны идти блоки catch? Сколько блоков catch будет выполнено?',
        'Общее правило: обрабатывать исключения нужно от «младшего» к старшему. Т.е. нельзя поставить в первый блок catch(Exception ex) {}, иначе все дальнейшие блоки catch() уже ничего не смогут обработать, т.к. любое исключение будет соответствовать обработчику catch(Exception ex).Таким образом, исходя из факта, что FileNotFoundException extends IOException сначала нужно обработать FileNotFoundException, а затем уже IOException.',
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (248, 'Что такое generics?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (249, 'Что такое «интернационализация», «локализация»?',
        ...
        3);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (250, '﻿Что такое «коллекция»?',
...
VALUES (252,
        ...
        '  Iterableo Collection§ List§ Set· SortedSeto NavigableSet  Mapo SortedMap§ NavigableMap  Iterator', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (253, 'Почему Map — это не Collection, в то время как List и Set являются Collection?',
        'Collection представляет собой совокупность некоторых элементов. Map - это совокупность пар «ключ-значение».',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (254, 'В чем разница между классами java.util.Collection и java.util.Collections?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (255, 'Что такое «fail-fast поведение»?',
        'fail-fast поведение означает, что при возникновении ошибки или состояния, которое может привести к ошибке, система немедленно прекращает дальнейшую работу и уведомляет об этом. Использование fail-fast подхода позволяет избежать недетерминированного поведения программы в течение времени.В Java Collections API некоторые итераторы ведут себя как fail-fast и выбрасывают ConcurrentModificationException, если после его создания была произведена модификация коллекции, т.е. добавлен или удален элемент напрямую из коллекции, а не используя методы итератора.Реализация такого поведения осуществляется за счет подсчета количества модификаций коллекции (modification count):  при изменении коллекции счетчик модификаций так же изменяется;  при создании итератора ему передается текущее значение счетчика;  при каждом обращении к итератору сохраненное значение счетчика сравнивается с текущим, и, если они не совпадают, возникает исключение.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (256, 'Какая разница между fail-fast и fail-safe?',
        'В противоположность fail-fast, итераторы fail-safe не вызывают никаких исключений при изменении структуры, потому что они работают с клоном коллекции вместо оригинала.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (257, 'Приведите примеры итераторов, реализующих поведение fail-safe',
        'Итератор коллекции CopyOnWriteArrayList и итератор представления keySet коллекции ConcurrentHashMap являются примерами итераторов fail-safe.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (258, 'Чем различаются Enumeration и Iterator.',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (259, 'Как между собой связаны Iterable и Iterator?',
        'Интерфейс Iterable имеет только один метод - iterator(), который возвращает Iterator.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (260, 'Как между собой связаны Iterable, Iterator и «for-each»?',
        'Классы, реализующие интерфейс Iterable, могут применяться в конструкции for-each, которая использует Iterator.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (261, 'Сравните Iterator и ListIterator.',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (262, 'Что произойдет при вызове Iterator.next() без предварительного вызова Iterator.hasNext()?',
...
VALUES (263,
        ...
        'Нисколько - hasNext() осуществляет только проверку наличия следующего элемента.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (264, 'Как поведёт себя коллекция, если вызвать iterator.remove()?',
        'Если вызову iterator.remove() предшествовал вызов iterator.next(), то iterator.remove() удалит элемент коллекции, на который указывает итератор, в противном случае будет выброшено IllegalStateException().',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (265, 'Как поведёт себя уже инстанциированный итератор для collection, если вызвать collection.remove()?',
        'При следующем вызове методов итератора будет выброшено ConcurrentModificationException.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (266, 'Как избежать ConcurrentModificationException во время перебора коллекции?',
        '  Попробовать подобрать или реализовать самостоятельно другой итератор, работающий по принципу fail-safe.  Использовать ConcurrentHashMap и CopyOnWriteArrayList.  Преобразовать список в массив и перебирать массив.  Блокировать изменения списка на время перебора с помощью блока synchronized.Отрицательная сторона последних двух вариантов - ухудшение производительности.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (267, 'Какая коллекция реализует дисциплину обслуживания FIFO?',
        'FIFO, First-In-First-Out («первым пришел-первым ушел») - по этому принципу построена коллекция Queue.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (268, 'Какая коллекция реализует дисциплину обслуживания FILO?',
        'FILO, First-In-Last-Out («первым пришел, последним ушел») - по этому принципу построена коллекция Stack.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (269, 'Чем отличается ArrayList от Vector?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (270, 'Чем отличается ArrayList от LinkedList? В каких случаях лучше использовать первый, а в каких второй?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (271, 'Что работает быстрее ArrayList или LinkedList?',
        'Смотря какие действия будут выполняться над структурой.см. Чем отличается ArrayList от LinkedList', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (272, 'Какое худшее время работы метода contains() для элемента, который есть в LinkedList?',
        'O(N). Время поиска элемента линейно пропорционально количеству элементов в списке.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (273, 'Какое худшее время работы метода contains() для элемента, который есть в ArrayList?',
        'O(N). Время поиска элемента линейно пропорционально количеству элементов с списке.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (274, 'Какое худшее время работы метода add() для LinkedList?',
        'O(N). Добавление в начало/конец списка осуществляется за время O(1).', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (275, 'Какое худшее время работы метода add() для ArrayList?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (276, 'Необходимо добавить 1 млн. элементов, какую структуру вы используете?',
        'Однозначный ответ можно дать только исходя из информации о том в какую часть списка происходит добавление элементов, что потом будет происходить с элементами списка, существуют ли какие-то ограничения по памяти или скорости выполнения.см. Чем отличается ArrayList от LinkedList',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (277, 'Как происходит удаление элементов из ArrayList? Как меняется в этом случае размер ArrayList?',
...
VALUES (278,
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (279, 'Сколько выделяется дополнительно памяти при вызове LinkedList.add()?',
        'Создается один новый экземпляр вложенного класса Node.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (280, 'Оцените количество памяти на хранение одного примитива типа byte в LinkedList?',
        'Каждый элемент LinkedList хранит ссылку на предыдущий элемент, следующий элемент и ссылку на данные.Для 32-битных систем каждая ссылка занимает 32 бита (4 байта). Сам объект (заголовок) вложенного класса Node занимает 8 байт. 4   4   4   8 = 20 байт, а т.к. размер каждого объекта в Java кратен 8, соответственно получаем 24 байта. Примитив типа byte занимает 1 байт памяти, но в JCF примитивы упаковываются: объект типа Byte занимает в памяти 16 байт (8 байт на заголовок объекта, 1 байт на поле типа byte и 7 байт для кратности 8). Также напомню, что значения от -128 до 127 кэшируются и для них новые объекты каждый раз не создаются. Таким образом, в x32 JVM 24 байта тратятся на хранение одного элемента в списке и 16 байт - на хранение упакованного объекта типа Byte. Итого 40 байт.Для 64-битной JVM каждая ссылка занимает 64 бита (8 байт), размер заголовка каждого объекта составляет 16 байт (два машинных слова). Вычисления аналогичны: 8   8   8   16 = 40байт и 24 байта. Итого 64 байта.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (281, 'Оцените количество памяти на хранение одного примитива типа byte в ArrayList?',
...
VALUES (283,
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (284, 'Сравните интерфейсы Queue и Deque.',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (285, 'Почему LinkedList реализует и List, и Deque?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (286, 'LinkedList — это односвязный, двусвязный или четырехсвязный список?',
        'Двусвязный: каждый элемент LinkedList хранит ссылку на предыдущий и следующий элементы.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (287, 'Как перебрать элементы LinkedList в обратном порядке, не используя медленный get(index)?',
        'Для этого в LinkedList есть обратный итератор, который можно получить вызва метод descendingIterator().', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (288, 'Что позволяет сделать PriorityQueue?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (289, 'Stack считается «устаревшим». Чем его рекомендуют заменять? Почему?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (290, 'Зачем нужен HashMap, если есть Hashtable?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (291, 'В чем разница между HashMap и IdentityHashMap? Для чего нужна IdentityHashMap?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (292, 'В чем разница между HashMap и WeakHashMap? Для чего используется WeakHashMap?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (293, 'В WeakHashMap используются WeakReferences. А почему бы не создать SoftHashMap на SoftReferences?',
        'SoftHashMap представлена в сторонних библиотеках, например, в Apache Commons.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (294, 'В WeakHashMap используются WeakReferences. А почему бы не создать PhantomHashMap на PhantomReferences?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (295, 'LinkedHashMap - что в нем от LinkedList, а что от HashMap?',
...
VALUES (296,
        ...
        'Так же оно проявляется при итерации по коллекции.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (297, 'Как устроен HashMap?',
...
VALUES (299,
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (300, 'Какое начальное количество корзин в HashMap?',
...
VALUES (301,
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (302, 'Возможна ли ситуация, когда HashMap выродится в список даже с ключами имеющими разные hashCode()?',
        'Это возможно в случае, если метод, определяющий номер корзины будет возвращать одинаковые значения.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (303, 'В каком случае может быть потерян элемент в HashMap?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (304, 'Почему нельзя использовать byte[] в качестве ключа в HashMap?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (305, 'Какова роль equals() и hashCode() в HashMap?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (306, 'Каково максимальное число значений hashCode()?',
        'Число значений следует из сигнатуры int hashCode() и равно диапазону типа int — 2<sup>32</sup>.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (307, 'Какое худшее время работы метода get(key) для ключа, которого нет в HashMap?',
        'Какое худшее время работы метода get(key) для ключа, который есть в HashMap?___O(N)___. Худший случай - это поиск ключа в HashMap, вырожденного в список по причине совпадения ключей по hashCode() и для выяснения хранится ли элемент с определённым ключом может потребоваться перебор всего списка.Но начиная с Java 8, после определенного числа элементов в списке, связный список преобразовывается в красно-черное дерево и сложность выборки, даже в случае плохой хеш-функции, не хуже логарифмической O(log(N))',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (308, 'Сколько переходов происходит в момент вызова HashMap.get(key) по ключу, который есть в таблице?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (309, 'Сколько создается новых объектов, когда вы добавляете новый элемент в HashMap?',
        'Один новый объект статического вложенного класса Entry<K,V>.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (310, 'Как и когда происходит увеличение количества корзин в HashMap?',
        'Помимо capacity у HashMap есть еще поле loadFactor, на основании которого, вычисляется предельное количество занятых корзин capacity * loadFactor. По умолчанию loadFactor = 0.75. По достижению предельного значения, число корзин увеличивается в 2 раза и для всех хранимых элементов вычисляется новое «местоположение» с учетом нового числа корзин.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (311, 'Объясните смысл параметров в конструкторе HashMap(int initialCapacity, float loadFactor).',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (312, 'Будет ли работать HashMap, если все добавляемые ключи будут иметь одинаковый hashCode()?',
        'Да, будет, но в этом случае HashMap вырождается в связный список и теряет свои преимущества.Как перебрать все ключи Map?Использовать метод keySet(), который возвращает множество Set<K> ключей.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (313, 'Как перебрать все значения Map?',
        'Использовать метод values(), который возвращает коллекцию Collection<V> значений.', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (314, 'Как перебрать все пары «ключ-значение» в Map?',
        'Использовать метод entrySet(), который возвращает множество Set<Map.Entry<K, V> пар «ключ-значение».', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (315, 'В чем отличия TreeSet и HashSet?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (316, 'Что будет, если добавлять элементы в TreeSet по возрастанию?',
        'В основе TreeSet лежит красно-черное дерево, которое умеет само себя балансировать. В итоге, TreeSet все равно в каком порядке вы добавляете в него элементы, преимущества этой структуры данных будут сохраняться.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (317, 'Чем LinkedHashSet отличается от HashSet?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (318, 'Для Enum есть специальный класс java.util.EnumSet. Зачем? Чем авторов не устраивал HashSet или TreeSet?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (319, 'Какие существуют способы перебирать элементы списка?', '  Цикл с итератором', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (320, 'Каким образом можно получить синхронизированные объекты стандартных коллекций?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (321, 'Как получить коллекцию только для чтения?',
        ...
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (322, 'к оглавлению',
        'Реализуйте симметрическую разность двух коллекций используя методы Collection (addAll(...), removeAll(...), retainAll(...)).Симметрическая разность двух коллекций - это множество элементов, одновременно не принадлежащих обоим исходным коллекциям.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (323, 'Как, используя LinkedHashMap, сделать кэш c «invalidation policy»?',
        'Необходимо использовать LRU-алгоритм (Least Recently Used algorithm) и LinkedHashMap с access-order. В этом случае при обращении к элементу он будет перемещаться в конец списка, а наименее используемые элементы будут постепенно группироваться в начале списка. Так же в стандартной реализации LinkedHashMap есть метод removeEldestEntries(), который возвращает true, если текущий объект LinkedHashMap должен удалить наименее используемый элемент из коллекции при использовании методов put() и putAll().Стоит заметить, что LinkedHashMap не позволяет полностью реализовать LRU-алгоритм, поскольку при вставке уже имеющегося в коллекции элемента порядок итерации по элементам не меняется.',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (324, 'Как одной строчкой скопировать элементы любой collection в массив?',
        'Object[] array = collection.toArray();', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (325, 'Как одним вызовом из List получить List со всеми элементами, кроме первых и последних 3-х?',
        'List<Integer> subList = list.subList(3, list.size() - 3);', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (326, 'Как одной строчкой преобразовать HashSet в ArrayList?',
        'ArrayList<Integer> list = new ArrayList<>(new HashSet<>());', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (327, 'Как одной строчкой преобразовать ArrayList в HashSet?',
        'HashSet<Integer> set = new HashSet<>(new ArrayList<>());', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (328, 'Сделайте HashSet из ключей HashMap.', 'HashSet<Object> set = new HashSet<>(map.keySet());', 4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (329, 'Сделайте HashMap из HashSet<Map.Entry<K, V>>.',
        'HashMap<K, V> map = new HashMap<>(set.size());for (Map.Entry<K, V> entry : set) {    map.put(entry.getKey(), entry.getValue());}',
        4);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (330, '﻿Какие нововведения, появились в Java 8 и JDK 8?',
        '  Методы интерфейсов по умолчанию;  Лямбда-выражения;  Функциональные интерфейсы;  Ссылки на методы и конструкторы;  Повторяемые аннотации;  Аннотации на типы данных;  Рефлексия для параметров методов;  Stream API для работы с коллекциями;  Параллельная сортировка массивов;  Новое API для работы с датами и временем;  Новый движок JavaScript Nashorn;  Добавлено несколько новых классов для потокобезопасной работы;  Добавлен новый API для Calendar и Locale;  Добавлена поддержка Unicode 6.2.0;  Добавлен стандартный класс для работы с Base64;  Добавлена поддержка беззнаковой арифметики;  Улучшена производительность конструктора java.lang.String(byte[], *) и метода java.lang.String.getBytes();  Новая реализация AccessController.doPrivileged, позволяющая устанавливать подмножество привилегий без необходимости проверки всех остальных уровней доступа;  Password-based алгоритмы стали более устойчивыми;  Добавлена поддержка SSL/TLS Server Name Indication (NSI) в JSSE Server;  Улучшено хранилище ключей (KeyStore);  Добавлен алгоритм SHA-224;  Удален мост JDBC - ODBC;  Удален PermGen, изменен способ хранения мета-данных классов;  Возможность создания профилей для платформы Java SE, которые включают в себя не всю платформу целиком, а некоторую ее часть;  Инструментарийo Добавлена утилита jjs для использования JavaScript Nashorn;o Команда java может запускать JavaFX приложения;o Добавлена утилита jdeps для анализа .class-файлов.',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (331, 'Что такое «лямбда»? Какова структура и особенности использования лямбда-выражения?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (332, 'К каким переменным есть доступ у лямбда-выражений?',
        'Доступ к переменным внешней области действия из лямбда-выражения очень схож к доступу из анонимных объектов. Можно ссылаться на:  неизменяемые (effectively final - не обязательно помеченные как final) локальные переменные;  поля класса;  статические переменные.К методам по умолчанию реализуемого функционального интерфейса обращаться внутри лямбда-выражения запрещено.',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (333, 'Как отсортировать список строк с помощью лямбда-выражения?',
        'public static List<String> sort(List<String> list){    Collections.sort(list, (a, b) -> a.compareTo(b));    return list;}',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (334, 'Что такое «ссылка на метод»?',
        'Если существующий в классе метод уже делает все, что необходимо, то можно воспользоваться механизмом method reference (ссылка на метод) для непосредственной передачи этого метода. Такая ссылка передается в виде:  имя_класса::имя_статического_метода для статического метода;  объект_класса::имя_метода для метода экземпляра;  название_класса::new для конструктора.Результат будет в точности таким же, как в случае определения лямбда-выражения, которое вызывает этот метод.private interface Measurable {    public int length(String string);}public static void main(String[] args) {    Measurable a = String::length;    System.out.println(a.length("abc"));}Ссылки на методы потенциально более эффективны, чем использование лямбда-выражений. Кроме того, они предоставляют компилятору более качественную информацию о типе и при возможности выбора между использованием ссылки на существующий метод и использованием лямбда-выражения, следует всегда предпочитать использование ссылки на метод.',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (335, 'Какие виды ссылок на методы вы знаете?',
        '  на статический метод;  на метод экземпляра;  на конструкторе.', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (336, 'Объясните выражение System.out::println.',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (337, 'Что такое «функциональные интерфейсы»?',
...
VALUES (344, 'Для чего нужен функциональный интерфейс BiConsumer<T,U>?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (345, 'Для чего нужен функциональный интерфейс BiFunction<T,U,R>?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (346, 'Для чего нужен функциональный интерфейс BiPredicate<T,U>?',
...
VALUES (348,
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (349, 'Для чего нужны функциональные интерфейсы ToDoubleFunction<T>, ToIntFunction<T> и ToLongFunction<T>?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (350, 'Для чего нужны функциональные интерфейсы ObjDoubleConsumer<T>, ObjIntConsumer<T> и ObjLongConsumer<T>?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (351, 'Что такое StringJoiner?',
        'Класс StringJoiner используется, чтобы создать последовательность строк, разделенных разделителем с возможностью присоединить к полученной строке префикс и суффикс:StringJoiner joiner = new StringJoiner(".", "prefix-", "-suffix");for (String s : "Hello the brave world".split(" ")) {    joiner.add(s);}System.out.println(joiner); //prefix-Hello.the.brave.world-suffix',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (352, 'Что такое default методы интрефейса?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (353, 'Как вызывать default метод интерфейса в реализующем этот интерфейс классе?',
        'Используя ключевое слово super вместе с именем интерфейса:', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (354, 'Что такое static метод интерфейса?',
...
VALUES (359, 'В чем разница между Collection и Stream?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (360, 'Для чего нужен метод collect() в стримах?',
        'Метод collect() является конечной операцией, которая используется для представление результата в виде коллекции или какой-либо другой структуры данных.collect() принимает на вход Collector<Тип_источника, Тип_аккумулятора, Тип_результата>, который содержит четыре этапа: supplier - инициализация аккумулятора, accumulator - обработка каждого элемента, combiner - соединение двух аккумуляторов при параллельном выполнении, [finisher] - необязательный метод последней обработки аккумулятора. В Java 8 в классе Collectors реализовано несколько распространённых коллекторов:  toList(), toCollection(), toSet() - представляют стрим в виде списка, коллекции или множества;  toConcurrentMap(), toMap() - позволяют преобразовать стрим в Map;  averagingInt(), averagingDouble(), averagingLong() - возвращают среднее значение;  summingInt(), summingDouble(), summingLong() - возвращает сумму;  summarizingInt(), summarizingDouble(), summarizingLong() - возвращают SummaryStatistics с разными агрегатными значениями;  partitioningBy() - разделяет коллекцию на две части по соответствию условию и возвращает их как Map<Boolean, List>;  groupingBy() - разделяет коллекцию на несколько частей и возвращает Map<N, List<T>>;  mapping() - дополнительные преобразования значений для сложных Collector-ов.Так же существует возможность создания собственного коллектора через Collector.of():',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (361, 'Для чего в стримах применяются методы forEach() и forEachOrdered()?',
        '  forEach() применяет функцию к каждому объекту стрима, порядок при параллельном выполнении не гарантируется;  forEachOrdered() применяет функцию к каждому объекту стрима с сохранением порядка элементов.',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (362, 'Для чего в стримах предназначены методы map() и mapToInt(), mapToDouble(), mapToLong()?',
        'Метод map() является промежуточной операцией, которая заданным образом преобразует каждый элемент стрима.mapToInt(), mapToDouble(), mapToLong() - аналоги map(), возвращающие соответствующий числовой стрим (то есть стрим из числовых примитивов):',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (363, 'Какова цель метода filter() в стримах?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (364, 'Для чего в стримах предназначен метод limit()?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (365, 'Для чего в стримах предназначен метод sorted()?',
        'Метод sorted() является промежуточной операцией, которая позволяет сортировать значения либо в натуральном порядке, либо задавая Comparator.Порядок элементов в исходной коллекции остается нетронутым - sorted() всего лишь создает его отсортированное представление.',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (366, 'Для чего в стримах предназначены методы flatMap(), flatMapToInt(), flatMapToDouble(), flatMapToLong()?',
...
VALUES (379, 'Что такое LocalDateTime?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (380, 'Что такое ZonedDateTime?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (381, 'Как получить текущую дату с использованием Date Time API из Java 8?', 'LocalDate.now();', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (382, 'Как добавить 1 неделю, 1 месяц, 1 год, 10 лет к текущей дате с использованием Date Time API?',
        'LocalDate.now().plusWeeks(1);LocalDate.now().plusMonths(1);LocalDate.now().plusYears(1);LocalDate.now().plus(1, ChronoUnit.DECADES);',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (383, 'Как получить следующий вторник используя Date Time API?',
        'LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.TUESDAY));', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (384, 'Как получить вторую субботу текущего месяца используя Date Time API?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (385, 'Как получить текущее время с точностью до миллисекунд используя Date Time API?',
        'new Date().toInstant();', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (386, 'Как получить текущее время по местному времени с точностью до миллисекунд используя Date Time API?',
        'LocalDateTime.ofInstant(new Date().toInstant(), ZoneId.systemDefault());', 5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (387, 'Как определить повторяемую аннотацию?',
...
VALUES (390, 'Какой класс появился в Java 8 для кодирования/декодирования данных?',
        ...
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (391, 'Как создать Base64 кодировщик и декодировщик?',
        '// EncodeString b64 = Base64.getEncoder().encodeToString("input".getBytes("utf-8")); //aW5wdXQ==// Decodenew String(Base64.getDecoder().decode("aW5wdXQ=="), "utf-8"); //input',
        5);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (392, '﻿Что такое JDBC?',
...
VALUES (407, '﻿Что такое «SQL»?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (408, 'Какие существуют операторы SQL?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (409, 'Что означает NULL в SQL?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (410, 'Что такое «временная таблица»? Для чего она используется?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (411, 'Что такое «представление» (view) и для чего оно применяется?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (412, 'Каков общий синтаксис оператора SELECT?',
...
VALUES (413, 'Что такое JOIN?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (414, 'Какие существуют типы JOIN?',
        '(INNER) JOINРезультатом объединения таблиц являются записи, общие для левой и правой таблиц. Порядок таблиц для оператора не важен, поскольку оператор является симметричным.LEFT (OUTER) JOINПроизводит выбор всех записей первой таблицы и соответствующих им записей второй таблицы. Если записи во второй таблице не найдены, то вместо них подставляется пустой результат (NULL). Порядок таблиц для оператора важен, поскольку оператор не является симметричным.RIGHT (OUTER) JOINLEFT JOIN с операндами, расставленными в обратном порядке. Порядок таблиц для оператора важен, поскольку оператор не является симметричным.FULL (OUTER) JOINРезультатом объединения таблиц являются все записи, которые присутствуют в таблицах. Порядок таблиц для оператора не важен, поскольку оператор является симметричным.CROSS JOIN (декартово произведение)При выборе каждая строка одной таблицы объединяется с каждой строкой второй таблицы, давая тем самым все возможные сочетания строк двух таблиц. Порядок таблиц для оператора не важен, поскольку оператор является симметричным.',
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (415, 'Что лучше использовать JOIN или подзапросы?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (416, 'Для чего используется оператор HAVING?',
        'HAVING используется для фильтрации результата GROUP BY по заданным логическим условиям.', 7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (417, 'В чем различие между операторами HAVING и WHERE?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (418, 'Для чего используется оператор ORDER BY?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (419, 'Для чего используется оператор GROUP BY?',
        'GROUP BY используется для агрегации записей результата по заданным признакам-атрибутам.', 7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (420, 'Как GROUP BY обрабатывает значение NULL?',
        'При использовании GROUP BY все значения NULL считаются равными.', 7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (421, 'В чем разница между операторами GROUP BY и DISTINCT?',
        'DISTINCT указывает, что для вычислений используются только уникальные значения столбца. NULL считается как отдельное значение.GROUP BY создает отдельную группу для всех возможных значений (включая значение NULL).Если нужно удалить только дубликаты лучше использовать DISTINCT, GROUP BY лучше использовать для определения групп записей, к которым могут применяться агрегатные функции.',
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (422, 'Перечислите основные агрегатные функции.',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (423, 'В чем разница между COUNT(*) и COUNT({column})?',
        'COUNT (*) подсчитывает количество записей в таблице, не игнорируя значение NULL, поскольку эта функция оперирует записями, а не столбцами.COUNT ({column}) подсчитывает количество значений в {column}. При подсчете количества значений столбца эта форма функции COUNT не принимает во внимание значение NULL.',
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (424, 'Что делает оператор EXISTS?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (425, 'Для чего используются операторы IN, BETWEEN, LIKE?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (426, 'Для чего применяется ключевое слово UNION?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (427, 'Какие ограничения на целостность данных существуют в SQL?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (428, 'Какие отличия между ограничениями PRIMARY и UNIQUE?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (429, 'Может ли значение в столбце, на который наложено ограничение FOREIGN KEY, равняться NULL?',
        'Может, если на данный столбец не наложено ограничение NOT NULL.', 7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (430, 'Как создать индекс?',
        'Индекс можно создать либо с помощью выражения CREATE INDEX:CREATE INDEX index_name ON table_name (column_name)либо указав ограничение целостности в виде уникального UNIQUE или первичного PRIMARY ключа в операторе создания таблицы CREATE TABLE.',
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (431, 'Что делает оператор MERGE?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (432, 'В чем отличие между операторами DELETE и TRUNCATE?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (433, 'Что такое «хранимая процедура»?',
...
VALUES (435, 'Что такое «курсор»?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (436, 'Опишите разницу типов данных DATETIME и TIMESTAMP.',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (437, 'Для каких числовых типов недопустимо использовать операции сложения/вычитания?',
        'В качестве операндов операций сложения и вычитания нельзя использовать числовой тип BIT.', 7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (438, 'Какое назначение у операторов PIVOT и UNPIVOT в Transact-SQL?',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (439, 'Расскажите об основных функциях ранжирования в Transact-SQL.',
        ...
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (440, 'Для чего используются операторы INTERSECT, EXCEPT в Transact-SQL?',
        'Оператор EXCEPT возвращает уникальные записи из левого входного запроса, которые не выводятся правым входным запросом.Оператор INTERSECT возвращает уникальные записи, выводимые левым и правым входными запросами.',
        7);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (441, '﻿Что такое WWW?',
        ...
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (442, 'Что такое W3C?',
        'W3C, World Wide Web Consortium (Консорциум Всемирной паутины) — организация, разрабатывающая и внедряющая технологические стандарты для WWW.W3C разрабатывает для Интернета единые принципы и стандарты, называемые «рекомендациями» (W3C Recommendations), которые затем внедряются производителями программ и оборудования. Таким образом достигается совместимость между программными продуктами и аппаратурой различных компаний.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (443, 'Какие существуют уровни модели OSI?',
        '#Уровень (layer)Тип данных (PDU)ФункцииПримеры7Прикладной (application)-Доступ к сетевым службамHTTP, FTP6Представительский (представления) (presentation)-Представление и шифрование данныхASCII, JPEG5Сеансовый (session)-Управление сеансом связиRPC, PAP4Транспортный (transport)Сегменты(segment) / Дейтаграммы(datagram)Прямая связь между конечными пунктами и надежностьTCP, UDP3Сетевой (network)Пакеты (packet)Определение маршрута и логическая адресацияIP, AppleTalk2Канальный (data link)Биты (bit) / Кадры (frame)Физическая адресацияEthernet, IEEE 802.2, L2TP1Физический (physical)Биты (bit)Работа со средой передачи, сигналами и двоичными даннымиUSB, витая пара',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (444, 'Что такое TCP/IP?',
        'TCP/IP - это два основных сетевых протокола Internet. Часто это название используют и для обозначения сетей, работающих на их основе.IP (Internet Protocol) - маршрутизируемый протокол, отвечающий за IP-адресацию, маршрутизацию, фрагментацию и восстановление пакетов. В его задачу входит продвижение пакета между сетями – от одного маршрутизатора до другого и тех пор, пока пакет не попадет в сеть назначения. В отличие от протоколов прикладного и транспортного уровней, протокол IP разворачивается не только на хостах, но и на всех шлюзах (маршрутизаторах). Этот протокол работает без установления соединения и без гарантированной доставки.В настоящее время используются следующие две версии протокола IP:  IPv6 — IP-адрес имеет разрядность 128 бит и записывается в виде восьми 16-битных полей, с использованием шестнадцатеричной системы счисления и с возможностью сокращения двух и более последовательных нулевых полей до ::, например: 2001:db8:42::1337:cafe  IPv4 — IP-адрес имеет разрядность 32 бита и записывается в виде четырех десятичных чисел в диапазоне 0 … 255 через точку, например: 192.0.2.34.TCP (Transfer Control Protocol) - протокол, обеспечивающий надежную, требующую логического соединения связь между двумя компьютерами. Отвечает за установление соединения, упорядочивание посылаемых пакетов и восстановление пакетов, потерянных в процессе передачи.Стек протоколов TCP/IP включает в себя четыре уровня:1. канальный уровень (link layer) - например Ethernet, IEEE 802.11 Wireless Ethernet, физическая среда и принципы кодирования информации2. сетевой уровень (Internet layer) - например IP3. транспортный уровень (transport layer) - например TCP, UDP4. прикладной уровень (application layer) - например HTTP, FTP, DNSTCP-соединение двух узлов начинается с handshake (рукопожатия):  Узел A посылает узлу B специальный пакет SYN — приглашение к соединению  B отвечает пакетом SYN-ACK — согласием об установлении соединения  A посылает пакет ACK — подтверждение, что согласие полученоПосле этого TCP соединение считается установленным и приложения, работающие в этих узлах, могут посылать друг другу пакеты с данными.В заголовке TCP/IP пакета указывается:  IP-адрес отправителя  IP-адрес получателя  Номер порта',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (445, 'Что такое UDP?',
        'UDP, User Datagram Protocol (Протокол пользовательских датаграмм) — протокол, который обеспечивает доставку без требований соединения с удаленным модулем UDP и обязательного подтверждения получения.К заголовку IP-пакета UDP добавляет всего четыре поля по 2 байта каждое:1. поле порта источника (source port)2. поле порта пункта назначения (destination port)3. поле длины (length)4. поле контрольной суммы (checksum)Поля «порт источника» и «контрольная сумма» не являются обязательными для использования в IPv4. В IPv6 необязательно только поле «порт отправителя».UDP используется DNS, SNMP, DHCP и другими приложениями.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (446, 'Чем отличаются TCP и UDP?',
        'TCP — ориентированный на соединение протокол, что означает необходимость «рукопожатия» для установки соединения между двумя хостами. Как только соединение установлено, пользователи могут отправлять данные в обоих направлениях.  Надёжность — TCP управляет подтверждением, повторной передачей и тайм-аутом сообщений. Производятся многочисленные попытки доставить сообщение. Если оно потеряется на пути, сервер вновь запросит потерянную часть. В TCP нет ни пропавших данных, ни (в случае многочисленных тайм-аутов) разорванных соединений.  Упорядоченность — если два сообщения последовательно отправлены, первое сообщение достигнет приложения-получателя первым. Если участки данных приходят в неверном порядке, TCP отправляет неупорядоченные данные в буфер до тех пор, пока все данные не могут быть упорядочены и переданы приложению.  Тяжеловесность — TCP необходимо три пакета для установки соединения перед тем, как отправить данные. TCP следит за надёжностью и перегрузками.  Потоковость — данные читаются как поток байтов, не передается никаких особых обозначений для границ сообщения или сегментов.UDP — более простой, основанный на сообщениях протокол без установления соединения. Протоколы такого типа не устанавливают выделенного соединения между двумя хостами. Связь достигается путём передачи информации в одном направлении от источника к получателю без проверки готовности или состояния получателя.  Ненадёжность — когда сообщение посылается, неизвестно, достигнет ли оно своего назначения — оно может потеряться по пути. Нет таких понятий как подтверждение, повторная передача, тайм-аут.  Неупорядоченность — если два сообщения отправлены одному получателю, то порядок их достижения цели не может быть предугадан.  Легковесность — никакого упорядочивания сообщений, никакого отслеживания соединений и т. д. Это лишь транспортный уровень.  Датаграммы — пакеты посылаются по отдельности и проверяются на целостность только если они прибыли. Пакеты имеют определенные границы, которые соблюдаются после получения, то есть операция чтения на получателе выдаст сообщение таким, каким оно было изначально послано.  Отсутствие контроля перегрузок — для приложений с большой пропускной способностью существует шанс вызвать коллапс перегрузок, если только они не реализуют меры контроля на прикладном уровне.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (447, 'Что такое протокол передачи данных? Какие протоколы вы знаете?',
        'Протокол передачи данных — набор соглашений интерфейса логического уровня, которые определяют обмен данными между различными программами. Эти соглашения задают единообразный способ передачи сообщений и обработки ошибок при взаимодействии программного обеспечения разнесённой в пространстве аппаратуры, соединённой тем или иным интерфейсом.Наиболее известные протоколы передачи данных:  HTTP (Hyper Text Transfer Protocol)  FTP (File Transfer Protocol)  POP3 (Post Office Protocol)  SMTP (Simple Mail Transfer Protocol)  TELNET (TErminaL NETwork)',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (448, 'Что такое HTTP и HTTPS? Чем они отличаются?',
        'HTTP, HyperText Transfer Protocol (Протокол передачи гипертекста) — протокол прикладного уровня передачи данных.Основой HTTP является технология «клиент-сервер»:  Потребители (клиенты), которые инициируют соединение и посылают запрос;  Поставщики (серверы), которые ожидают соединения для получения запроса, производят необходимые действия и возвращают обратно сообщение с результатом.Для идентификации ресурсов HTTP использует глобальные URI.HTTP не сохраняет своего состояния. Это означает отсутствие сохранения промежуточного состояния между парами «запрос-ответ».Структура протокола:1. Стартовая строка (starting line) — определяет тип сообщения;2. Заголовки (headers) — характеризуют тело сообщения, параметры передачи и прочие сведения;3. Тело сообщения (message body) — непосредственно данные сообщения. Обязательно должно отделяться от заголовков пустой строкой.Заголовки и тело сообщения могут отсутствовать, но стартовая строка является обязательным элементом, так как указывает на тип запроса/ответа.HTTPS, HyperText Transfer Protocol Secure — расширение протокола HTTP, поддерживающее шифрование. Данные, передаваемые по протоколу HTTPS, «упаковываются» в криптографический протокол SSL или TLS, что обеспечивает защиту от атак, основанных на прослушивании сетевого соединения (при условии, что будут использоваться шифрующие средства и сертификат сервера проверен и ему доверяют).Различия HTTP и HTTPS:  HTTPS является расширением HTTP.  HTTP использует не зашифрованное соединение. Соединение по HTTPS поддерживает шифрование.  Работа по HTTP быстрей и менее ресурсоёмко, т.к. шифрование HTTPS требует дополнительных затрат.  Порты по умолчанию: в случае HTTP это TCP-порт 80, для HTTPS - TCP-порт 443.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (449, 'Что такое FTP?',
        'FTP, File Transfer Protocol (Протокол передачи файлов) — протокол передачи файлов между компьютерами в сети TCP. С его помощью можно подключаться к FTP-серверам, просматривать содержимое их каталогов и загружать файлы с сервера или на сервер. Протокол построен на архитектуре «клиент-сервер» и использует разные сетевые соединения для передачи команд и данных между клиентом и сервером.По умолчанию использует TCP-порт 21.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (450, 'Чем отличаются методы GET и POST?',
...
VALUES (451, 'Что такое MIME тип?',
        ...
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (452, 'Что такое Web server?',
        'Web server (Веб-сервер) — сервер, принимающий HTTP-запросы от клиентов и выдающий им HTTP-ответы. Так называют как программное обеспечение, выполняющее функции web-сервера, так и непосредственно компьютер, на котором это программное обеспечение работает.Web-серверы могут иметь различные дополнительные функции, например:  автоматизация работы web-страниц;  ведение журнала обращений пользователей к ресурсам;  аутентификация и авторизация пользователей;  поддержка динамически генерируемых страниц;  поддержка HTTPS для защищённых соединений с клиентами.Наиболее известные web-серверы:  Apache  Microsoft IIS  nginx',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (453, 'Что такое Web application?',
        ...
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (454, 'Что такое Application server?',
        'Application Server (Сервер приложений) — программа, представляющая собой сервер, который занимается системной поддержкой приложений и обеспечивает их жизненный цикл в соответствии с правилами, определёнными в спецификациях. Может работать как полноценный самостоятельный web-сервер или быть поставщиком страниц для другого web-сервера. Обеспечивает обмен данными между приложениями и клиентами, берёт на себя выполнение таких функций, как создание программной среды для функционирующего приложения, идентификацию и авторизацию клиентов, организацию сессии для каждого из них.Наиболее известные серверы приложений Java:  Apache Tomcat  Jetty  JBoss  GlassFish  IBM WebSphere  Oracle Weblogic',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (455, 'Чем отличаются Web server и Application server?',
        ...
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (456, 'Что такое AJAX? Как принципиально устроена эта технология?',
        'AJAX, Asynchronous Javascript and XML (Асинхронный Javascript и XML) — подход к построению интерактивных пользовательских интерфейсов web-приложений, заключающийся в «фоновом» обмене данными браузера и web-сервера. В результате, при обновлении данных web-страница не перезагружается полностью и web-приложения становятся быстрее и удобнее.При использовании AJAX:1. Пользователь заходит на web-страницу и взаимодействует с каким-нибудь её элементом.2. Скрипт на языке JavaScript определяет, какая информация необходима для обновления страницы.3. Браузер отправляет соответствующий запрос на web-сервер.4. Web-сервер возвращает только ту часть документа, на которую пришёл запрос.5. Скрипт вносит изменения с учётом полученной информации (без полной перезагрузки страницы).AJAX базируется на двух основных принципах:1. использование технологии динамического обращения к серверу «на лету» (без перезагрузки страницы полностью) через динамическое создание:o дочерних фреймов;o тега <script>;o тега <img>.2. использование DHTML для динамического изменения содержания страницы;AJAX не является самостоятельной технологией, это концепция использования нескольких смежных технологий:  (X)HTML, CSS для подачи и стилизации информации;  DOM-модель, операции над которой производятся Javascript на стороне клиента, для обеспечения динамического отображения и взаимодействия с информацией;  XMLHttpRequest или другой транспорт (IFrame, SCRIPT-тег, ...) для асинхронного обмена данными с web-сервером;  JSON или любой другой подходящий формат (форматированный HTML, текст, XML, ...) для обмена данными.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (457, 'Что такое WebSocket?',
        'WebSocket — протокол полнодуплексной связи поверх TCP-соединения, предназначенный для обмена сообщениями между браузером и web-сервером в режиме реального времени.Протокол WebSocket определяет две URI схемы  ws: - нешифрованное соединение  wss: - шифрованное соединение',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (458, 'Что такое JSON?',
        'JSON, JavaScript Object Notation — текстовый формат обмена данными, основанный на JavaScript.JSON представляет собой (в закодированном виде) одну из двух структур:  Набор пар «ключ:значение»;  Упорядоченный набор значений.Ключом может быть только строка (регистрозависимая: имена с буквами в разных регистрах считаются разными).В качестве значений могут быть использованы:  Объект — неупорядоченное множество пар «ключ:значение», заключённое в фигурные скобки { }. Ключ описывается строкой, между ним и значением стоит символ :. Пары ключ-значение отделяются друг от друга запятыми;  Массив (одномерный) — упорядоченное множество значений. Массив заключается в квадратные скобки [ ]. Значения разделяются запятыми.  Число;  Литералы true, false и null;  Строка — упорядоченное множество из нуля или более символов Unicode, заключенное в кавычки " ". Символы могут быть указаны с использованием escape-последовательностей, начинающихся с обратной косой черты \\, или записаны шестнадцатеричным кодом в кодировке UTF-8 в виде \\uFFFF.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (459, 'Что такое JSON схема?',
...
VALUES (461, 'Что такое «сессия»?',
        ...
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (462, 'Что такое «авторизация» и «аутентификация»? Чем они отличаются?',
        'Аутентификация - это проверка соответствия субъекта и того, за кого он пытается себя выдать, с помощью некой уникальной информации (отпечатки пальцев, цвет радужки, голос и тд.), в простейшем случае - с помощью имени входа и пароля.Авторизация - это проверка и определение полномочий на выполнение некоторых действий (например, чтение файла) в соответствии с ранее выполненной аутентификацией.Очевидно, что это разные понятия, но при этом без первого не может быть второго и наоборот. То есть имея разрешение на работу, вы не сможете оказаться на рабочем месте без предъявления пропуска, равно как и нет смысла в демонстрации пропуска, если вы не планируете работать. Именно тот факт, что одного не бывает без другого, и вызывает у людей заблуждение, что это одно и то же.',
        8);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (463, '﻿Что такое «сервлет»?',
        'Сервлет является интерфейсом, реализация которого расширяет функциональные возможности сервера. Сервлет взаимодействует с клиентами посредством принципа запрос-ответ. Хотя сервлеты могут обслуживать любые запросы, они обычно используются для расширения веб-серверов.Большинство необходимых для создания сервлетов классов и интерфейсов содержатся в пакетах javax.servlet и javax.servlet.http.Основные методы сервлета:  public void init(ServletConfig config) throws ServletException запускается сразу после загрузки сервлета в память;  public ServletConfig getServletConfig() возвращает ссылку на объект, который предоставляет доступ к информации о конфигурации сервлета;  public String getServletInfo() возвращает строку, содержащую информацию о сервлете, например: автор и версия сервлета;  public void service(ServletRequest request, ServletResponse response) throws ServletException, java.io.IOException вызывается для обработки каждого запроса;  public void destroy() выполняется перед выгрузкой сервлета из памяти.Текущая спецификация - Servlet 3.1 описана в JSR-340 и принята в 2013 году.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (464, 'В чем заключаются преимущества технологии сервлетов над CGI (Common Gateway Interface)?',
        '  Сервлеты предоставляют лучшую производительность обработки запросов и более эффективное использование памяти за счет использования преимущество многопоточности (на каждый запрос создается новая нить, что быстрее выделения памяти под новый объект для каждого запроса, как это происходит в CGI).  Сервлеты, как платформа и система являются независимыми. Таким образом веб-приложение, написанное с использованием сервлетов может быть запущена в любом контейнере сервлетов, реализующим этот стандарт и в любой операционной системе.  Использование сервлетов повышает надежность программы, т.к. контейнер сервлетов самостоятельно заботится о жизненном цикле сервлетов (а значит и за утечками памяти), безопасности и сборщике мусора.  Сервлеты относительно легки в изучении и поддержке, таким образом разработчику необходимо заботиться только о бизнес-логике приложения, а не внутренней реализации веб-технологий.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (465, 'Какова структура веб-проекта?',
        'src/main/java Исходники приложения/библиотекиsrc/main/resources Ресурсные файлы приложения/библиотекиsrc/main/filters Файлы сервлетных фильтровsrc/main/webapp Исходники веб-приложенияsrc/test/java Исходники тестовsrc/test/resources Ресурсные файлы тестовsrc/test/filters Тесты сервлетных фильтровsrc/it Интеграционные тестыsrc/assembly Описание сборкиsrc/site СайтLICENSE.txt Лицензия проектаNOTICE.txt Замечания и определения библиотек зависимостей.README.txt Описание проекта',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (466, 'Что такое «контейнер сервлетов»?',
        'Контейнер сервлетов — программа, представляющая собой сервер, который занимается системной поддержкой сервлетов и обеспечивает их жизненный цикл в соответствии с правилами, определёнными в спецификациях. Может работать как полноценный самостоятельный веб-сервер, быть поставщиком страниц для другого веб-сервера, или интегрироваться в Java EE сервер приложений.Контейнер сервлетов обеспечивает обмен данными между сервлетом и клиентами, берёт на себя выполнение таких функций, как создание программной среды для функционирующего сервлета, идентификацию и авторизацию клиентов, организацию сессии для каждого из них.Наиболее известные реализации контейнеров сервлетов:  Apache Tomcat  Jetty  JBoss  WildFly  GlassFish  IBM WebSphere  Oracle Weblogic',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (467, 'Зачем нужны сервера приложений, если есть контейнеры сервлетов?',
        '  Пулы соединений с БДo Возможность периодического тестирования доступности СУБД и обновления соединения в случае восстановления после сбоевo Замена прав доступа при подключенииo Балансировка нагрузки между несколькими СУБД, определение доступность или недоступность того или иного узлаo Защита пула соединений от некорректного кода в приложении, которое по недосмотру не возвращает соединения, просто отбирая его после какого-то таймаута.  JMSo Доступность сервера очередей сообщений "из-коробки".o Возможность кластеризации очередей, т.е. доступность построения распределенных очередей, расположенных сразу на нескольких серверах, что существенно увеличивает масштабируемость и доступность приложенияo Возможность миграции очередей - в случае падения одного из серверов, его очереди автоматически перемещаются на другой, сохраняя необработанные сообщения.o В некоторых серверах приложений поддерживается Unit-of-Order - гарантированный порядок обработки сообщений, удовлетворяющих некоторым критериям.  JTA Встроенная поддержка распределенных транзакций для обеспечения согласованности данных в разные СУБД или очереди.  Безопасностьo Наличие множества провайдеров безопасности и аутентификации:§ во встроенном или внешнем LDAP-сервере§ в базе данных§ в различных Internet-directory (специализированных приложениях для управления правами доступа)o Доступность Single-Sign-On (возможности разделения пользовательской сессии между приложениями) посредством Security Assertion Markup Language (SAML) 1/2 или Simple and Protected Negotiate (SPNEGO) и Kerberos: один из серверов выступает в роли базы для хранения пользователей, все другие сервера при аутентификации пользователя обращаются к этой базе.o Возможность авторизации посредством протокола eXtensible Access Control Markup Language (XACML), позволяющего описывать довольно сложные политики (например, приложение доступно пользователю только в рабочее время).o Кластеризация всего вышеперечисленного  Масштабируемость и высокая доступность Для контейнера сервлетов обычно так же возможно настроить кластеризацию, но она будет довольно примитивной, так как в случае его использования имеются следующие ограничения:o Сложность передачи пользовательской сессии из одного центра обработки данных (ЦоД) в другой через Интернетo Отсутствие возможности эффективно настроить репликации сессий на большом (состоящем из 40-50 экземпляров серверов) кластереo Невозможность обеспечения миграции экземпляров приложения на другой серверo Недоступность механизмов автоматического мониторинга и реакции на ошибки  Управляемостьo Присутствие единого центра управления, т.н. AdminServer и аналога NodeManager’а, обеспечивающего§ Возможность одновременного запуска нескольких экземпляров сервера§ Просмотр состояния запущенных экземпляров сервера, обработчиков той или иной очереди, на том или ином сервере, количества соединений с той или иной БД  Административный канал и развертывание в промышленном режиме Некоторые сервера приложений позволяют включить так называемый "административный канал" - отдельный порт, запросы по которому имеют приоритет.o Просмотр состояния (выполняющихся транзакций, потоков, очередей) в случае недоступности ("зависания") сервераo Обновление приложений "на-лету", без простоя:§ добавление на сервер новой версии приложения в "закрытом" режиме, пока пользователи продолжают работать со предыдущей§ тестирование корректности развертывания новой версии§ "скрытый" перевод на использование новой версии всех пользователей',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (468, 'Как контейнер сервлетов управляет жизненным циклом сервлета, когда и какие методы вызываются?',
        'Контейнер сервлетов управляет четырьмя фазами жизненного цикла сервлета:  Загрузка класса сервлета — когда контейнер получает запрос для сервлета, то происходит загрузка класса сервлета в память и вызов его конструктора без параметров.  Инициализация класса сервлета — после того как класс загружен контейнер инициализирует объект ServletConfig для этого сервлета и внедряет его через init() метод. Это и есть место где сервлет класс преобразуется из обычного класса в сервлет.  Обработка запросов — после инициализации сервлет готов к обработке запросов. Для каждого запроса клиента сервлет контейнер порождает новый поток и вызывает метод service() путем передачи ссылки на объекты ответа и запроса.  Удаление - когда контейнер останавливается или останавливается приложение, то контейнер сервлетов уничтожает классы сервлетов путем вызова destroy() метода.Таким образом, сервлет создаётся при первом обращении к нему и живёт на протяжении всего времени работы приложения (в отличии от объектов классов, которые уничтожаются сборщиком мусора после того, как они уже не используются) и весь жизненный цикл сервлета можно описать как последовательность вызова методов:  public void init(ServletConfig config) – используется контейнером для инициализации сервлета. Вызывается один раз за время жизни сервлета.  public void service(ServletRequest request, ServletResponse response) – вызывается для каждого запроса. Метод не может быть вызван раньше выполнения init() метода.  public void destroy() – вызывается для уничтожения сервлета (один раз за время жизни сервлета).',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (469, 'Что такое «дескриптор развертывания»?',
        'Дескриптор развертывания — это конфигурационный файл артефакта, который будет развернут в контейнере сервлетов. В спецификации Java Platform, Enterprise Edition дескриптор развертывания описывает то, как компонент, модуль или приложение (такое, как веб-приложение или приложение предприятия) должно быть развернуто.Этот конфигурационный файл указывает параметры развертывания для модуля или приложения с определенными настройками, параметры безопасности и описывает конкретные требования к конфигурации. Для синтаксиса файлов дескриптора развертывания используется язык XML.Для веб-приложений дескриптор развертывания должен называться web.xml и находиться в директории WEB-INF, в корне веб-приложения. Этот файл является стандартным дескриптором развертывания, определенным в спецификации. Также есть и другие типы дескрипторов, такие, как файл дескриптора развертывания sun-web.xml, содержащий специфичные для Sun GlassFish Enterprise Server данные для развертывания именно для этого сервера приложений или файл application.xml в директории META-INF для приложений J2EE.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (470, 'Какие действия необходимо проделать при создании сервлетов?',
        'Чтобы создать сервлет ExampleServlet, необходимо описать его в дескрипторе развёртывания:Затем создать класс xyz.company.ExampleServlet путём наследования от HttpServlet и реализовать логику его работы в методе service() или методах doGet()/doPost().',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (471, 'В каком случае требуется переопределять метод service()?',
        'Метод service() переопределяется, когда необходимо, чтобы сервлет обрабатывал все запросы (и GET, и POST) в одном методе.Когда контейнер сервлетов получает запрос клиента, то происходит вызов метода service(), который в зависимости от поступившего запроса вызывает или метод doGet() или метод doPost().',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (472, 'Есть ли смысл определять для сервлета конструктор? Каким образом лучше инициализировать данные?',
...
VALUES (486, 'Как из одного сервлета вызвать другой сервлет?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (487, 'Чем отличается sendRedirect() от forward()?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (488, 'Для чего используются атрибуты сервлетов и как происходит работа с ними?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (489, 'Каким образом можно допустить в сервлете deadlock?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (490, 'Как получить реальное расположение сервлета на сервере?',
        'Реальный путь к расположению сервлета на сервере можно получить из объекта ServletContext:getServletContext().getRealPath(request.getServletPath()).',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (491, 'Как получить информацию о сервере из сервлета?',
        'Информацию о сервере можно получить из объекта ServletContext:getServletContext().getServerInfo().', 9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (492, 'Как получить IP адрес клиента на сервере?',
        'IP адрес клиента можно получить вызвав request.getRemoteAddr().', 9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (493, 'Какие классы-обертки для сервлетов вы знаете?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (494, 'В чем отличия GenericServlet и HttpServlet?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (495, 'Почему HttpServlet класс объявлен как абстрактный?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (496, 'Какие основные методы присутствуют в классе HttpServlet?',
        '  doGet() - для обработки HTTP запросов GET;  doPost() - для обработки HTTP запросов POST;  doPut() - для обработки HTTP запросов PUT;  doDelete() - для обработки HTTP запросов DELETE;  doHead() - для обработки HTTP запросов HEAD;  doOptions() - для обработки HTTP запросов OPTIONS;  doTrace() - для обработки HTTP запросов TRACE.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (497, 'Стоит ли волноваться о многопоточной безопасности работая с сервлетами?',
        'Методы init() и destroy() вызываются один раз за жизненный цикл сервлета — поэтому по поводу них беспокоиться не стоит.Методы doGet(), doPost(), service() вызываются на каждый запрос клиента и т.к. сервлеты используют многопоточность, то здесь задумываться о потокобезопасной работе обязательно. При этом правила использования многопоточности остаются теми же: локальные переменные этих методов будут созданы отдельно для каждого потока, а при использовании глобальных разделяемых ресурсов необходимо использовать синхронизацию или другие приёмы многопоточного программирования.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (498, 'Какой метод HTTP не является неизменяемым?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (499, 'Какие есть методы отправки данных с клиента на сервер?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (500, 'В чем разница между методами GET и POST?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (501, 'В чем разница между PrintWriter и ServletOutputStream?',
        'PrintWriter — класс для работы с символьным потоком, экземпляр которого можно получить через метод ServletResponse getWriter();ServletOutputStream — класс для работы байтовым потоком. Для получения его экземпляра используется метод ServletResponse getOutputStream().',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (502, 'Можно ли одновременно использовать в сервлете PrintWriter и ServletOutputStream?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (503, 'Расскажите об интерфейсе SingleThreadModel.',
...
VALUES (508, 'Что такое URL Rewriting?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (509, 'Зачем нужны и чем отличаются методы encodeURL() и encodeRedirectURL()?',
        'HttpServletResponse.encodeURL() предоставляет способ преобразования URL в HTML гиперссылку с преобразованием спецсимволов и пробелов, а так же добавления session id к URL. Такое поведение аналогично java.net.URLEncoder.encode(), но с добавлением дополнительного параметра jsessionid в конец URL.Метод HttpServletResponse.encodeRedirectURL() преобразует URL для последующего использования в методе sendRedirect().Таким образом для HTML гиперссылок при URL rewriting необходимо использовать encodeURL(), а для URL при перенаправлении - encodeRedirectUrl().',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (510, 'Что такое «сессия»?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (511, 'Как уведомить объект в сессии, что сессия недействительна или закончилась?',
...
VALUES (512,
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (513, 'Как мы можем обеспечить transport layer security для нашего веб приложения?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (514, 'Как организовать подключение к базе данных, обеспечить журналирование в сервлете?',
        'При работе с большим количеством подключений к базе данных рекомендуется инициализировать их в servlet context listener, а также установить в качестве атрибута контекста для возможности использования другими сервлетами.Журналирование подключается к сервлету стандартным для логгера способом (например для log4j это может быть property-файл или XML-конфигурация) , а далее эта информация используется при настройке соответствующего context listener.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (515, 'Какие основные особенности появились в спецификации Servlet 3?',
        '  Servlet Annotations. До Servlet 3 вся конфигурация содержалась в web.xml, что приводило к ошибкам и неудобству при работе с большим количестве сервлетов. Примеры аннотаций: @WebServlet, @WebInitParam, @WebFilter, @WebListener.  Web Fragments. Одностраничное веб приложение может содержать множество модулей: все модули прописываются в fragment.xml в папке META-INF\\. Это позволяет разделять веб приложение на отдельные модули, собранные как .jar-файлы в отдельной lib\\ директории.  Динамическое добавление веб компонентов. Появилась возможность программно добавлять фильтры и слушатели, используя ServletContext объект. Для этого применяются методы addServlet(), addFilter(), addListener(). Используя это нововведение стало доступным построение динамической системы, в которой необходимый объект будет создан и вызван только по необходимости.  Асинхронное выполнение. Поддержка асинхронной обработки позволяет передать выполнение запроса в другой поток без удержания всего сервера занятым.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (516, 'Какие способы аутентификации доступны сервлету?',
        'Спецификация сервлетов определяет четыре типа проверки подлинности:  HTTP Basic Authentication - BASIC. При доступе к закрытым ресурсам появится окно, которое попросит ввести данные для аутентификации.  Form Based Login - FORM. Используется собственная html форма:  HTTP Digest Authentication - DIGEST. Цифровая аутентификация с шифрованием.  HTTPS Authentication - CLIENT-CERT. Аутентификация с помощью клиентского сертификата.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (517, 'Что такое Java Server Pages (JSP)?',
...
VALUES (518, 'Зачем нужен JSP?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (519, 'Опишите, как обрабатываются JSP страницы, начиная от запроса к серверу, заканчивая ответом пользователю.',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (520, 'Расскажите об этапах (фазах) жизненного цикла JSP.',
...
VALUES (531, 'Какие неявные объекты не доступны в обычной JSP странице?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (532, 'Что вы знаете о PageContext и какие преимущества его использования?',
        'Неявный объект JSP - экземпляр класса javax.servlet.jsp.PageContext предоставляет доступ ко всем пространствам имён, ассоциированным с JSP-страницей, а также к различным её атрибутам.Остальные неявные объекты добавляются к pageContext автоматически.Класс PageContext это абстрактный класс, а его экземпляр можно получить через вызов метода JspFactory.getPageContext(), и освободить через вызов метода JspFactory.releasePageContext().PageContext обладает следующим набором особенностей и возможностей:  единый API для обслуживания пространств имён различных областей видимости;  несколько удобных API для доступа к различным public-объектам;  механизм получения JspWriter для вывода;  механизм обслуживания использования сессии страницей;  механизм экспонирования («показа») атрибутов директивы page среде скриптинга;  механизмы направления или включения текущего запроса в другие компоненты приложения;  механизм обработки процессов исключений на страницах ошибок errorpage;',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (533, 'Как сконфигурировать параметры инициализации для JSP?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (534, 'Почему не рекомендуется использовать скриплеты (скриптовые элементы) в JSP?',
...
VALUES (538, 'Назовите неявные, внутренние объекты JSP EL и их отличия от объектов JSP.',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (539, 'Как отключить возможность использования EL в JSP?',
        'Для игнорирования выполнения языка выражений на странице существует два способа:  использовать директиву <%@ page isELIgnored = «true» %>,  настроить web.xml (лучше подходит для отключения EL сразу на нескольких страницах):',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (540, 'Как узнать тип HTTP метода используя JSP EL?', '${pageContext.request.method}.', 9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (541, 'Что такое JSTL (JSP Standard tag library)?',
        'JavaServer Pages Standard Tag Library, JSTL, Стандартная библиотека тегов JSP — расширение спецификации JSP (конечный результат JSR 52), добавляющее библиотеку JSP тегов для общих нужд, таких как разбор XML данных, условная обработка, создание циклов и поддержка интернационализации.JSTL является альтернативой такому виду встроенной в JSP логики, как скриплеты (прямые вставки Java кода). Использование стандартизованного множества тегов предпочтительнее, поскольку получаемый код легче поддерживать и проще отделять бизнес-логику от логики отображения.Для использования JSTL тегов необходимо:  подключить зависимости, например в pom.xml:  указать пространство имен основных тегов JSTL через указание на JSP странице код:',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (542, 'Из каких групп тегов состоит библиотека JSTL?',
        'Группы тегов JSTL согласно их функциональности:  Core Tags предоставляют возможности итерации, обработки исключений, URL, forward, redirect response и т.д.  Formatting Tags и Localization Tags предоставляют возможности по форматированию чисел, дат и поддержки i18n локализации и resource bundles.  SQL Tags – поддержка работы с базами данных.  XML Tags используются для работы с XML документами: парсинга, преобразования данных, выполнения выражений XPath и т.д..  JSTL Functions Tags предоставляет набор функций, которые позволяют выполнять различные операции со строками и т.п. Например, по конкатенации или разбиению строк.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (543, 'Какая разница между <c:set> и <jsp:useBean>?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (544, 'Чем отличается <c:import> от <jsp:include> и директивы <%@include %>?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (545, 'Как можно расширить функциональность JSP?', 'Что вы знаете о написании пользовательских JSP тегов?', 9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (546, 'Как сделать перенос строки в HTML средствами JSP?',
        'Для переноса строки можно использовать тег c:out и атрибут escapeXml, который отключает обработку HTML элементов. В этом случае браузер получит следующий код в виде строки и обработает элемент <br> как требуется:<c:out value="<br> creates a new line in HTML" escapeXml="true"></c:out>',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (547, 'Почему не нужно конфигурировать стандартные JSP теги в web.xml?',
        'Стандартные теги JSP не конфигурируются в web.xml, потому что tld файлы уже находятся внутри каталога /META-INF/ в jar файлах JSTL.Когда контейнер загружает веб-приложение и находит tld файлы в в jar файле в директории /META-INF/, то он автоматически настраивает их для непосредственного использования на JSP страницах. Остается только задать пространство имен на JSP странице.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (548, 'Как можно обработать ошибки JSP страниц?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (549, 'Как происходит обработка ошибок с помощью JSTL?',
        'Для перехвата и обработки исключений в служебных методах класса служат JSTL Core Tags c:catch и c:if.Тег c:catch перехватывает исключение и обертывает его в переменную exception, доступную для обработки в теге c:if:Обратите внимание что используется язык выражений JSP EL в теге c:if.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (550, 'Как конфигурируется JSP в дескрипторе развертывания.',
        'Для настройки различных параметров JSP страниц используется элемент jsp-config, который отвечает за:  управление элементами скриптлетов на странице;  управления выполнением в языке выражений;  определение шаблона URL для encoding;  определение размера буфера, который используется для объектов на странице;  обозначение групп ресурсов, соответствующих шаблону URL, которые должны быть обработаны как XML документ.',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (551, 'Можно ли использовать Javascript на JSP странице?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (552, 'Всегда ли создается объект сессии на JSP странице, можно ли отключить его создание?',
        'Jsp-страница, по умолчанию, всегда создает сессию. Используя директиву page с атрибутом session можно изменить это поведение:<%@ page session ="false" %>',
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (553, 'Какая разница между JSPWriter и сервлетным PrintWriter?',
        ...
        9);
INSERT INTO exercises (id, question, answer, topic_id)
VALUES (554, 'Опишите общие практические принципы работы с JSP.',
        'Хорошей практикой работы с технологией JSP является соблюдение следующих правил:  Следует избегать использования элементов скриптлетов на странице. Если элементы action, JSTL, JSP EL не удовлетворяют потребностям, то желательно написать собственный тег.  Рекомендуется использовать разные виды комментариев: так JSP комментарии необходимы для уровня кода и отладки, т.к. они не будут показаны клиенту.  Не стоит размещать какой-либо бизнес логики внутри JSP страницы. Страницы должны использоваться только для создания ответов клиенту.  Для повышения производительности лучше отключать создание сессии на странице, когда это не требуется.  Директивы taglib, page в начале JSP страницы улучшают читабельность кода.  Следует правильно использовать директиву include и элемент jsp:include action. Первая используется для статических ресурсов, а второй для динамических ресурсов времени выполнения.  Обработку исключений нужно производить с помощью страниц ошибок. Это помогает избегать запуска специальных служебных методов и может повысить производительность.  Использующиеся CSS и JavaScript должны быть разнесены в разные файлы и подключаться в начале страницы.  В большинстве случаев JSTL должно хватать для всех нужд. Если это не так, то в начале следует проанализировать логику своего приложения, и попробовать перенести выполнения кода в сервлет, а далее с помощью установки атрибутов использовать на JSP странице только результат.',
        9);
